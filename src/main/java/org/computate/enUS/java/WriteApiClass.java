		...
		if(writerGenApiServiceImpl != null) {
			...
			for(String classApiMethod : classApiMethods) {
				...
				if(classApiMethod.contains("POST")) {
					...
					tl(19, "} else {");
					tl(20, "erreurCalculInr(siteRequest, eventHandler, i);");
					tl(19, "}");
					tl(18, "});");
					tl(17, "} else {");
					tl(18, "erreurCalculInr(siteRequest, eventHandler, h);");
					tl(17, "}");
					tl(16, "});");
					tl(15, "} else {");
					tl(16, "erreurCalculInr(siteRequest, eventHandler, g);");
					tl(15, "}");
					tl(14, "});");
					tl(13, "} else {");
					tl(14, "erreurCalculInr(siteRequest, eventHandler, f);");
					tl(13, "}");
					tl(12, "});");
					tl(11, "} else {");
					tl(12, "erreurCalculInr(siteRequest, eventHandler, e);");
					tl(11, "}");
					tl(10, "});");
					tl(9, "} else {");
					tl(10, "erreurCalculInr(siteRequest, eventHandler, d);");
					tl(9, "}");
					tl(8, "});");
					tl(7, "} else {");
					tl(8, "erreurCalculInr(siteRequest, eventHandler, c);");
					tl(7, "}");
					tl(6, "});");
					tl(5, "} else {");
					tl(6, "erreurCalculInr(siteRequest, eventHandler, b);");
					tl(5, "}");
					tl(4, "});");
					tl(3, "} else {");
					tl(4, "erreurCalculInr(siteRequest, eventHandler, a);");
					tl(3, "}");
					tl(2, "});");
				}
