...
//						ecrireApiEnsembleInfo(langueNom);
  ...
  public void ecrireGenClasse(JsonObject doc, String langueNom) throws Exception { 
    ...
    classeVarAltitudeMetres = doc.getString("classeVarAltitudeMetres_" + langueNom + "_stored_string");
    ...
    classeVarGltf = doc.getString("classeVarGltf_" + langueNom + "_stored_string");
    classe3d = classeVarAltitudeMetres != null && classeVarTangage != null && classeVarLacet != null && classeVarRoulis != null && classeVarRotation != null;
    ...
    classeVarEmplacementSvg = doc.getString("classeVarEmplacementSvg_" + classeLangueNom + "_stored_string");
    classeVarEmplacementRayon = doc.getString("classeVarEmplacementRayon_" + classeLangueNom + "_stored_string");
    classeVarAire = doc.getString("classeVarAire_" + classeLangueNom + "_stored_string");
    classeVarAireCouleur = doc.getString("classeVarAireCouleur_" + classeLangueNom + "_stored_string");
    classeVarAireTitre = doc.getString("classeVarAireTitre_" + classeLangueNom + "_stored_string");
    classeVarAireUrl = doc.getString("classeVarAireUrl_" + langueNom + "_stored_string");
    classeVarModifie = doc.getString("classeVarModifie_" + classeLangueNom + "_stored_string");
    classeVarCree = doc.getString("classeVarCree_" + classeLangueNom + "_stored_string");
    classeVarTitre = doc.getString("classeVarTitre_" + classeLangueNom + "_stored_string");
    ...
    classeMessage = doc.getString("classeMessage_stored_string");
