...
public class EcrireGenClasse extends EcrireClasse { 
  ...
  protected String classeVarAltitudeMetres;
  ...
  protected String classeVarGltf;
  ...
  protected Boolean entiteEstSubstitue;
  protected Boolean entiteEstListe;
  protected Boolean entiteEstZonedDateTime;
...
//						}	
  ...
  public void genCodeEntite(String langueNom, JsonObject langueConfig) throws Exception {
    ...
    entiteEstSubstitue = doc.getBoolean("entiteEstSubstitue_stored_boolean");
    if(entiteNomCanonique != null && !entiteEstSubstitue) {
      ...
      entiteEstListe = (StringUtils.equals(entiteNomCanonique, ArrayList.class.getCanonicalName()) || StringUtils.equals(entiteNomCanonique, List.class.getCanonicalName()));

      entiteEstZonedDateTime = StringUtils.equals(entiteNomCanonique, ZonedDateTime.class.getCanonicalName())
...
//											entiteValsEcrivain.tl(2 + p, "sx(", langueConfig.getString(ConfigCles.var_requeteSite), "_.getUtilisateurId() == null ? ", entiteVar, entiteValVar, entiteValVarNumero, " : ", entiteValCode, ");");
      ...
      if(entiteIgnorer) {
        ...
        if(entiteNomSimple.equals("List") || entiteNomSimple.equals("ArrayList") || entiteNomSimple.equals("Set") || entiteNomSimple.equals("HashSet")) {
          ...
          else if("Unit".equals(entiteNomSimple)) {
            tl(1, "@JsonProperty");
          ...
          else if("Quantity".equals(entiteNomSimple)) {
            tl(1, "@JsonProperty");
      ...
      if(classePartsRequeteSite != null) {
        ...
        if(StringUtils.equals(entiteNomCanonique, BigDecimal.class.getCanonicalName())
          ...
          tl(2, "if(NumberUtils.isParsable(o))");
          tl(3, "return new BigDecimal(o, staticMathContext", entiteVarCapitalise, "()).setScale(staticScale", entiteVarCapitalise, "(), RoundingMode.valueOf(\"", entiteModeDArrondi, "\"));");
          tl(2, "return null;");
          tl(1, "}");
          tl(1, "@JsonIgnore");
          tl(1, "public void set", entiteVarCapitalise, "(Double o) {");
          tl(2, entiteEstListe ? "add" : "set", entiteVarCapitalise, "(new BigDecimal(o, staticMathContext", entiteVarCapitalise, "()).setScale(staticScale", entiteVarCapitalise, "(), RoundingMode.valueOf(\"", entiteModeDArrondi, "\")));");
          tl(1, "}");
          tl(1, "@JsonIgnore");
          ...
          tl(2, entiteEstListe ? "add" : "set", entiteVarCapitalise, "(new BigDecimal(o.doubleValue(), staticMathContext", entiteVarCapitalise, "()).setScale(staticScale", entiteVarCapitalise, "(), RoundingMode.valueOf(\"", entiteModeDArrondi, "\")));");
          tl(1, "}");
          staticSet = true;
        }
        ...
        if(
          ...
          tl(6, "}");
          tl(5, "});");
          tl(5, "ObjectMapper objectMapper = JsonMapper.builder().addModule(module).build();");
        ...
        if(StringUtils.equals(entiteNomCanonique, Unit.class.getCanonicalName())
          ...
          tl(1, "public static ", entiteEstListe ? entiteNomSimpleCompletGenerique : entiteNomSimpleComplet, " staticSet", entiteVarCapitalise, "(", classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.nomSimple(langueNom), " ", langueConfig.getString(I18n.var_requeteSite), "_, String o) {");
          tl(2, "if(o != null)");
          tl(3, "return SimpleUnitFormat.getInstance().parse(o);");
          tl(2, "return null;");
          tl(1, "}");
          staticSet = true;
        }
      ...
      if(StringUtils.equals(entiteNomCanonique, List.class.getCanonicalName()) || StringUtils.equals(entiteNomCanonique, ArrayList.class.getCanonicalName()) || StringUtils.equals(entiteNomCanonique, Set.class.getCanonicalName()) || StringUtils.equals(entiteNomCanonique, HashSet.class.getCanonicalName())) {
        ...
        if((activerVertx || activerQuarkus) && StringUtils.equals(entiteNomCanoniqueGenerique, BigDecimal.class.getCanonicalName())) {
          ...
          tl(2, "for(int i = 0; i < objects.size(); i++) {");
          tl(3, entiteListeNomSimpleVertxJson, " o = objects.get", entiteListeNomSimpleVertxJson, "(i);");
          tl(3, "add", entiteVarCapitalise, "(new BigDecimal(o, staticMathContext", entiteVarCapitalise, "()).setScale(staticScale", entiteVarCapitalise, "(), RoundingMode.valueOf(\"", entiteModeDArrondi, "\")));");
          tl(2, "}");
          tl(1, "}");
          tl(1, "public ", classeNomSimple, " add", entiteVarCapitalise, "(String o) {");
          tl(2, "if(NumberUtils.isParsable(o)) {");
          tl(3, entiteNomSimpleCompletGenerique, " p = new BigDecimal(o, staticMathContext", entiteVarCapitalise, "()).setScale(staticScale", entiteVarCapitalise, "(), RoundingMode.valueOf(\"", entiteModeDArrondi, "\"));");
          tl(3, "add", entiteVarCapitalise, "(p);");
          tl(2, "}");
          tl(2, "return (", classeNomSimple, ")this;");
          tl(1, "}");
  ...
  public void genCodeEntiteInitialise(String langueNom, JsonObject langueConfig) throws Exception {
    if(entiteNomCanonique != null && !entiteEstSubstitue) {
      ...
      if(classeContientRequeteSite && entiteNomSimple != null && entiteSolrNomCanonique != null) {
        ...
        if(entiteDefinir || entiteAttribuer) {
          ...
          if(VAL_nomCanoniqueZonedDateTime.equals(entiteNomCanonique)) {
            ...
            tl(1, "public String sql", entiteVarCapitalise, "() {");
            tl(2, "return ", entiteVar, ".toString();");
            tl(1, "}");
          } else {
...
//		if(classeInitLoin && (classeEtendBase || classeEstBase)) {
    ...
    if(classePartsRequeteSite != null && classeInitLoin && (classeEtendBase || classeEstBase)) {
      ...
      if(classeEtendModeleBase || classeEtendResultatBase) {
        ...
        tl(3, "} else {");
        tl(4, classePartsListeRecherche.nomSimple(classeLangueNom), "<", classeNomSimple, "> ", i18nGlobale.getString(I18n.var_listeRecherche), " = new ", classePartsListeRecherche.nomSimple(classeLangueNom), "<", classeNomSimple, ">();");
        ...
        tl(4, i18nGlobale.getString(I18n.var_listeRecherche), ".fq(String.format(\"%s:\", ", classeNomSimple, ".var", langueConfig.getString(I18n.var_Indexe), classeNomSimple, "(var)) + SearchTool.escapeQueryChars(val.toString()));");
        ...
        tl(5, "try {");
        tl(6, "promise.complete(", i18nGlobale.getString(I18n.var_listeRecherche), ".getList().stream().findFirst().orElse(null));");
        tl(5, "} catch(Throwable ex) {");
        tl(6, "LOG.error(\"", String.format(langueConfig.getString(I18n.str_Erreur_lors_de_linterrogation_), classeLeNom), "\", ex);");
        tl(6, "promise.fail(ex);");
        tl(5, "}");
        tl(4, "}).onFailure(ex -> {");
        tl(5, "LOG.error(\"", String.format(langueConfig.getString(I18n.str_Erreur_lors_de_linterrogation_), classeLeNom), "\", ex);");
        tl(5, "promise.fail(ex);");
        tl(4, "});");
        tl(3, "}");
        tl(2, "} catch(Throwable ex) {");
        tl(3, "LOG.error(\"", String.format(langueConfig.getString(I18n.str_Erreur_lors_de_linterrogation_), classeLeNom), "\", ex);");
        tl(3, "promise.fail(ex);");
        tl(2, "}");
        tl(2, "return promise.future();");
        tl(1, "}");
      ...
      l();
      tl(1, "public static Object staticSearch", langueConfig.getString(I18n.var_PourClasse), "(String ", langueConfig.getString(I18n.var_entite), "Var, ", classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.nomSimple(langueNom), " ", langueConfig.getString(I18n.var_requeteSite), "_, Object o) {");
