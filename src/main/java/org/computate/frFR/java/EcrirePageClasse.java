...
public class EcrirePageClasse extends EcrireApiClasse {
	...
	public Boolean ecrireFormEntite(String langueNom, ToutEcrivain wForm, String classeApiMethodeMethode) {
		...
		if(entiteHtml) {
			...
			wForm.t(3).l("{{> \"htm", entiteVarCapitalise, "\" ", str_classeApiMethodeMethode(langueNom), "=\"", classeApiMethodeMethode, "\"}}");
		}
		return resultat;
	}
	...
	public void pageCodeClasse(String langueNom) throws Exception {
		...
		if(!classePageCheminsGen.contains(classePageCheminGen) && classePageCheminGen != null && StringUtils.equals(classePageLangueNom, langueNom)) {
			...
			if(classeEtendBase) {
				s("{{#partial \"htmHead\"}}");
				s("{{> \"htmHead", classePageNomSimple, "\"}}");
				l("{{/partial}}");
				s("{{#partial \"htmBody\"}}");
				s("{{> \"htmBody", classePageNomSimple, "\"}}");
				l("{{/partial}}");
			}
...
//				ecrireCommentaire(classeCommentaire, 0); 
			...
			tl(1, "}");
			l();
			tl(1, "protected void _", StringUtils.uncapitalize(classeNomSimple), "Count(", classePartsCouverture.nomSimple(langueNom), "<Integer> w) {");
			tl(2, "w.o(", str_liste(langueNom), classeNomSimple, "_ == null ? 0 : ", str_liste(langueNom), classeNomSimple, "_.size());");
			tl(1, "}");
			l();
			...
			if(classePageSimple) {
				...
				tl(2, "if(", StringUtils.uncapitalize(classeNomSimple), "Count == 1)");
			...
			if(classeVarH1 != null) {
				tl(2, "if(", StringUtils.uncapitalize(classeNomSimple), "_ != null && ", StringUtils.uncapitalize(classeNomSimple), "_.get", StringUtils.capitalize(classeVarTitre), "() != null)");
				tl(3, "c.o(", StringUtils.uncapitalize(classeNomSimple), "_.get", StringUtils.capitalize(classeVarTitre), "()", ");");
				if(contexteH1 != null) {
					tl(2, "else");
			...
			if(classeVarTitre != null) {
				tl(2, "if(", StringUtils.uncapitalize(classeNomSimple), "_ != null && ", StringUtils.uncapitalize(classeNomSimple), "_.get", StringUtils.capitalize(classeVarTitre), "() != null)");
				tl(3, "c.o(", StringUtils.uncapitalize(classeNomSimple), "_.get", StringUtils.capitalize(classeVarTitre), "()", ");");
				tl(2, "else if(", StringUtils.uncapitalize(classeNomSimple), "_ != null)");
			} else {
				tl(2, "if(", StringUtils.uncapitalize(classeNomSimple), "_ != null)");
			}
			tl(3, "c.o(", q(contexteTitre), ");");
			if(!classePageSimple) {
				tl(2, "else if(", str_liste(langueNom), classeNomSimple, "_ == null || ", StringUtils.uncapitalize(classeNomSimple), "Count == 0)");
			...
			tl(2, "Long ", str_debut(langueNom), " = ", str_liste(langueNom), classeNomSimple, "_.getStart().longValue();");
			tl(2, "Long ", str_lignes(langueNom), " = ", str_liste(langueNom), classeNomSimple, "_.getRows().longValue();");
			tl(2, "Long ", str_numTrouve(langueNom), " = ", str_liste(langueNom), classeNomSimple, "_.getQueryResponse().getResults().getNumFound();");
			...
			tl(2, "Long num = ", str_liste(langueNom), classeNomSimple, "_.getQueryResponse().getResults().getNumFound();");
			tl(2, "String q = \"*:*\";");
			...
			tl(2, "query.put(\"q\", q);");
			l();
			tl(2, "Integer rows1 = Optional.ofNullable(", str_liste(langueNom), classeNomSimple, "_).map(l -> l.getRows()).orElse(10);");
			tl(2, "Integer start1 = Optional.ofNullable(", str_liste(langueNom), classeNomSimple, "_).map(l -> l.getStart()).orElse(1);");
			...
			tl(2, "for(String fq : Optional.ofNullable(", str_liste(langueNom), classeNomSimple, "_).map(l -> l.getFilterQueries()).orElse(new String[0])) {");
			...
			tl(2, "for(SortClause sort : Optional.ofNullable(", str_liste(langueNom), classeNomSimple, "_).map(l -> l.getSorts()).orElse(Arrays.asList())) {");
...
//												}
			...
			if(classeEtendBase) {
				...
				tl(0, "{{#partial \"htmTitle\"}}");
				tl(0, "{{> \"htmTitle", classePageNomSimple, "\"}}");
				tl(0, "{{/partial}}");

				tl(0, "{{#partial \"htmMeta\"}}");
				tl(0, "{{> \"htmMeta", classePageNomSimple, "\"}}");
				tl(0, "{{/partial}}");

				tl(0, "{{#partial \"htmStyle\"}}");
				tl(0, "{{> \"htmStyle", classePageNomSimple, "\"}}");
				tl(0, "{{/partial}}");

				tl(0, "{{#partial \"htmScripts\"}}");
				tl(0, "{{> \"htmScripts", classePageNomSimple, "\"}}");
				tl(0, "{{/partial}}");
			}
			...
			t(2, "<title>");
				s("{{#if ", str_liste(langueNom), classeNomSimple, "_}}");
				s("{{#eq ", StringUtils.uncapitalize(classeNomSimple), "Count int1}}");
				s("{{#eq params.query.q \"*:*\"}}");
...
//					tl(2, "tl(1, ", q("});"), ");");
				tl(3, "});");
				tl(0, "{{/inline}}");
				tl(0, "{{#*inline \"htmFormPage", classeNomSimple, "\"}}");
				s(wFormPage);
				tl(0, "{{/inline}}");
				tl(0, "{{#*inline \"htmFormPOST", classeNomSimple, "\"}}");
				s(wFormPOST);
				tl(0, "{{/inline}}");
				tl(0, "{{#*inline \"htmFormPUTImport", classeNomSimple, "\"}}");
				...
				tl(2, "</div>");
				tl(0, "{{/inline}}");
				tl(0, "{{#*inline \"htmForm", str_PUTFusion(langueNom), classeNomSimple, "\"}}");
				tl(2, "<div class=\"w3-cell-row \">");
				tl(3, "<textarea");
				...
				tl(2, "</div>");
				tl(0, "{{/inline}}");
				tl(0, "{{#*inline \"htmForm", str_PUTCopie(langueNom), classeNomSimple, "\"}}");
				s(wFormPUTCopie);
				tl(0, "{{/inline}}");
				tl(0, "{{#*inline \"htmFormPATCH", classeNomSimple, "\"}}");
				s(wFormPATCH);
				tl(0, "{{/inline}}");
				tl(0, "{{#*inline \"htmForm", str_Recherche(langueNom), classeNomSimple, "\"}}");
				s(wFormRecherche);
				tl(0, "{{/inline}}");
			}
...
//					tl(4, "<div class=\"w3-padding-16 w3-card-4 w3-light-grey \">");
				...
				tl(5, "{{> \"table1", classePageNomSimple, "\"}}");
				tl(4, "</div>");
				tl(3, "{{/eq}}");
				tl(2, "{{/eq}}");
...
//					tl(2, "{{# if ", str_liste(langueNom), classeNomSimple, "_ != null && ", str_liste(langueNom), classeNomSimple, "_.size() == 1 && params.getJsonObject(\"query\").getString(\"q\").equals(\"*:*\") && params.getJsonObject(\"query\").getJsonArray(\"fq\") == null) {");
				...
				if(classeVarClePrimaire != null) {
					...
					tl(9, "/>");
					tl(7, "</form>");
					tl(7, "{{> \"htmFormPage", classeNomSimple, "\"}}");
					tl(6, "{{/if}}");
				}
				...
				// formulaires
				if(!classePageSimple) {
					tl(2, "{{> \"htmBodyForms", classePageNomSimple, "\"}}");
				}
...
//				tl(3, "SimpleOrderedMap facets = (SimpleOrderedMap)Optional.ofNullable(", str_liste(langueNom), classeNomSimple, "_.getQueryResponse()).map(QueryResponse::getResponse).map(r -> r.get(\"facets\")).orElse(new SimpleOrderedMap());");
				...
				tl(1, "{{/inline}}");
				s(wGetters);
				tl(0, "{{#*inline \"htmBodyForms", classePageNomSimple, "\"}}");
				if(!classePageSimple) {
...
//											tl(7+ tab, "o.set", str_RequeteSite(langueNom), "_(", str_requeteSite(langueNom), "_);");
											if("PATCH".equals(classeApiMethodeMethode) || str_PUTFusion(langueNom).equals(classeApiMethodeMethode) || str_PUTCopie(langueNom).equals(classeApiMethodeMethode) || "PUTImport".equals(classeApiMethodeMethode)) {
												...
												if("DELETE".equals(classeApiMethodeMethode))
													tl(7 + tab, "{{> \"htmFormPATCH", classeNomSimple, "\" o=o}}");
												else
													tl(7 + tab, "{{> \"htmForm", classeApiMethodeMethode, classeNomSimple, "\" o=o}}");
												...
												if("DELETE".equals(classeApiMethodeMethode))
													tl(8 + tab, "{{> \"htmFormPATCH", classeNomSimple, "\" o=o}}");
												else if("PUTImport".equals(classeApiMethode))
													tl(8 + tab, "{{> \"htmFormPUTImport", classeNomSimple, "\" o=o}}");
												else if(str_PUTFusion(langueNom).equals(classeApiMethode))
													tl(8 + tab, "{{> \"htmForm", str_PUTFusion(langueNom), classeNomSimple, "\" o=o}}");
												else if(str_PUTCopie(langueNom).equals(classeApiMethode))
													tl(8 + tab, "{{> \"htmForm", str_PUTCopie(langueNom), classeNomSimple, "\" o=o}}");
												else
													tl(8 + tab, "{{> \"htmForm", classeApiMethodeMethode, classeNomSimple, "\" o}}");
					...
					tl(2, "{{> \"htm", str_Suggere(langueNom), classeGenPageNomSimple, "\"}}");
				}
				tl(0, "{{/inline}}");
			}
...
//				}
//				tl(1, "**/");
				tl(0, "{{#*inline \"htm", str_Suggere(langueNom), classeGenPageNomSimple, "\"}}");
//					tl(1, "public static void htm", str_Suggere(langueNom), classeGenPageNomSimple, "(", classePartsMiseEnPage.nomSimple(langueNom), " p, String id, ", str_ListeRecherche(langueNom), "<", classeNomSimple, "> ", str_liste(langueNom), classeNomSimple, "_) {");
...
//				tl(2, "}");
				...
				if(classeMethodeVars.contains("htmBody" + str_Court(langueNom))) {
					...
					tl(2, StringUtils.uncapitalize(classeNomSimple), ".htmBody" + str_Court(langueNom) + "();");
					tl(0, "{{/inline}}");
				}
