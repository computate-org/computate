...
public class EcrirePageClasse extends EcrireApiClasse {
	...
	public Boolean ecrireFormEntite(String langueNom, ToutEcrivain wForm, String classeApiMethodeMethode) {
		...
		if(entiteHtml) {
			...
			if(entiteModifier && (entiteDefinir || entiteAttribuer && "Page".equals(classeApiMethodeMethode))) {
				...
				wForm.t(tIndex + 4).be("form").da("action", classeApiUri).da("id", str_suggere(langueNom), classeNomSimple, entiteVarCapitalise).da("style", "display: inline-block; width: 100%; ").da("onsubmit", "event.preventDefault(); return false; ").dfl();
				wForm.t(tIndex + 5).be("div").da("class", "w3-card ").dfl();

				if(entiteAttribuer) {
					if(entiteNomAffichage != null) {
						wForm.t(tIndex + 6).be("div").da("class", "w3-cell-row ").dfl();
						wForm.t(tIndex + 7).be("a").da("href", entiteAttribuerPageUri).da("class", "w3-cell w3-btn w3-center h4 w3-block h4 w3-", entiteAttribuerContexteCouleur, " w3-hover-", entiteAttribuerContexteCouleur, " ").dfl();
					...
					wForm.t(tIndex + 6).be("div").da("class", "w3-cell-row ").dfl();
					wForm.t(tIndex + 7).be("h5").da("class", "w3-cell ").dfl();
					wForm.t(tIndex + 8).sxqscl(str_relier(langueNom), " ", entiteListeTypeJson == null ? entiteAttribuerContexteUnNom : entiteAttribuerContexteNomPluriel, " ", str_a(langueNom), " ", contexteCeNom);
					wForm.t(tIndex + 7).bgl("h5");
					wForm.t(tIndex + 6).bgl("div");
					...
					if(entiteNomAffichage != null) {
						wForm.t(tIndex + 10).dal("placeholder", entiteNomAffichage);
					}
					if(entiteDescription != null) {
						wForm.t(tIndex + 10).dal("title", entiteDescription);
					}
	
					wForm.t(tIndex + 10).dal("class", str_valeur(langueNom), StringUtils.capitalize(entiteAttribuerVarSuggere), " ", str_suggere(langueNom), entiteVarCapitalise, " w3-input w3-border w3-cell w3-cell-middle ");
					wForm.t(tIndex + 10).dal("name", "set", entiteVarCapitalise);
					wForm.t(tIndex + 10).dal("id", classeApiMethodeMethode, "_", entiteVar);
					wForm.t(tIndex + 10).dal("autocomplete", "off");
					wForm.t(tIndex + 10).dal("oninput", str_suggere(langueNom), classeNomSimple, entiteVarCapitalise, "($('#' + ($(this).val() ? '", str_suggere(langueNom), "' : 'form') + '", classeNomSimple, entiteVarCapitalise, "'), $('#", "list", classeNomSimple, entiteVarCapitalise, "_", classeApiMethodeMethode, "')); ");
					...
					wForm.t(tIndex + 8).be("ul").da("class", "w3-ul w3-hoverable ").da("id", "list", classeNomSimple, entiteVarCapitalise, "_", classeApiMethodeMethode).dfl();
					...
					wForm.s(", function() { ");
					wForm.s(str_suggere(langueNom), classeNomSimple, entiteVarCapitalise, "($('#' + ($('#", classeApiMethodeMethode, "_", entiteVar, "').val() ? '", str_suggere(langueNom), "' : 'form') + '", classeNomSimple, entiteVarCapitalise, "'), $('#", "list", classeNomSimple, entiteVarCapitalise, "_", classeApiMethodeMethode, "')); ");
					...
					if("Page".equals(classeApiMethodeMethode)) {
						wForm.t(tIndex + 9).dal("onchange", "patch", classeNomSimple, "Val([{ name: 'fq', value: 'pk:' + $('#", classeNomSimple, "Form :input[name=\"pk\"]').val() }], 'set", entiteVarCapitalise, "', $(this).prop('checked'), function() { ", str_ajouterLueur(langueNom), "($('#", classeApiMethodeMethode, "_", entiteVar, "')); }, function() { ", str_ajouterErreur(langueNom), "($('#", classeApiMethodeMethode, "_", entiteVar, "')); }); ");
					}
					wForm.tl(tIndex + 9, ";");
					...
					if("Page".equals(classeApiMethodeMethode)) {
						wForm.t(tIndex + 9).dal("onclick", str_enleverLueur(langueNom), "($(this)); ");
						wForm.t(tIndex + 9).dal("onchange", "patch", classeNomSimple, "Val([{ name: 'fq', value: 'pk:' + $('#", classeNomSimple, "Form :input[name=\"pk\"]').val() }], 'set", entiteVarCapitalise, "', $(this).val(), function() { ", str_ajouterLueur(langueNom), "($('#", classeApiMethodeMethode, "_", entiteVar, "')); }, function() { ", str_ajouterErreur(langueNom), "($('#", classeApiMethodeMethode, "_", entiteVar, "')); }); ");
					}
				...
				if(!entiteAttribuer && entiteModifier && !"Boolean".equals(entiteNomSimple) && "Page".equals(classeApiMethodeMethode)) {
					...
					wForm.t(tIndex + 8).dal("onclick", str_enleverLueur(langueNom), "($('#", classeApiMethodeMethode, "_", entiteVar, "')); $('#", classeApiMethodeMethode, "_", entiteVar, "').val(null); patch", classeNomSimple, "Val([{ name: 'fq', value: 'pk:' + $('#", classeNomSimple, "Form :input[name=\"pk\"]').val() }], 'set", entiteVarCapitalise, "', null, function() { ", str_ajouterLueur(langueNom), "($('#", classeApiMethodeMethode, "_", entiteVar, "')); }, function() { ", str_ajouterErreur(langueNom), "($('#", classeApiMethodeMethode, "_", entiteVar, "')); }); ");
			...
			else if(!(entiteAttribuer && "Page".equals(classeApiMethodeMethode))) {
					...
					if(rechercheListe.size() > 0) {
						...
						for(Long i = rechercheListe.getStart(); i < rechercheListe.getNumFound(); i+=rechercheLignes) {
							for(Integer j = 0; j < rechercheListe.size(); j++) {
								...
								if(entiteAttribuer) {
									wJsInit.tl(2, "tl(1, ", q(str_suggere(langueNom), classeNomSimple, entiteVarCapitalise, "($('#", "form", classeNomSimple, entiteVarCapitalise, "'), $('#", "list", classeNomSimple, entiteVarCapitalise, "_", "Page", "')); "), ");");
								}
							}
...
//								auteurPageJs.tl(2, "}");
							...
							if(methodePATCH || methodePOST || methodeRecherche) {
								auteurPageJs.tl(2, ", dataType: 'json'");
								auteurPageJs.tl(2, ", type: '", classeApiMethodeMethode, "'");
								auteurPageJs.tl(2, ", contentType: 'application/json; charset=utf-8'");
									...
									for(Long i = rechercheListe.getStart(); i < rechercheListe.getNumFound(); i+=rechercheLignes) {
										for(Integer j = 0; j < rechercheListe.size(); j++) {
											...
											if(entiteSuggere) {
												...
												auteurPageJs.tl(3, "var $i = $('<i>').attr('class', 'fa", StringUtils.substring(contexteIconeGroupe, 0, 1), " fa-", contexteIconeNom, " w3-padding-small ');");
												...
												auteurPageJs.tl(2, "$list.empty();");
												auteurPageJs.tl(2, "$.each(data['list'], function(i, o) {");
												auteurPageJs.tl(3, "var $i = $('<i>').attr('class', 'fa", StringUtils.substring(entiteAttribuerContexteIconeGroupe, 0, 1), " fa-", entiteAttribuerContexteIconeNom, " w3-padding-small ');");
												auteurPageJs.t(3, "var $span = $('<span>').attr('class', '').text(");
												...
												auteurPageJs.tl(3, "$input.attr('id', '", classeApiMethodeMethode, "_", entiteVar, "_' + pk + '_", entiteAttribuerVar, "_' + o['pk']);");
												...
												if("array".equals(entiteAttribuerTypeJson)) {
													auteurPageJs.s(", function() { ", entiteAttribuerOperationIdPATCH, "Vals([{ name: 'fq', value: 'pk:\" + o['pk'] + \"' }], {}, function() { ", str_ajouterLueur(langueNom), "($input); }, function() { ", str_ajouterErreur(langueNom), "($input); } ); }");
												}
												else {
													auteurPageJs.s(", function() { ", entiteAttribuerOperationIdPATCH, "Vals([{ name: 'fq', value: 'pk:\" + o['pk'] + \"' }], {}, function() { ", str_ajouterLueur(langueNom), "($input); }, function() { ", str_ajouterErreur(langueNom), "($input); } ); }");
												}
												...
												auteurPageJs.tl(3, "$input.attr('onclick', '", str_enleverLueur(langueNom), "($(this)); ');");
												...
												if(entiteAttribuerTrisVar != null) {
													...
													for(String entiteAttribuerTriVar : entiteAttribuerTrisVar) {
														...
														auteurPageJs.l();
														if(entiteAttribuerTriVarAncien != null)
															auteurPageJs.tl(3, "if(", entiteAttribuerTriVarAncien, ") {");
														...
														auteurPageJs.tl(k, "$sortInput.attr('id', \"", str_attribuer(langueNom), "_\" + o['pk'] + \"_", str_tri(langueNom), "_", entiteAttribuerTriVar, "\");");
														auteurPageJs.tl(k, "$sortInput.attr('value', ", entiteAttribuerTriVar, ").attr('onchange', ");
														auteurPageJs.tl(k + 1, "\"", entiteAttribuerOperationIdPATCH, "Vals([{ name: 'fq', value: 'pk:\" + o['pk'] + \"' }], { ['set", StringUtils.capitalize(entiteAttribuerTriVar), "']: $(this).val() ? $(this).val() : null }\"");
														auteurPageJs.tl(k + 2, "+ \", function() { \"");
														auteurPageJs.tl(k + 2, "+ \"}\"");
														auteurPageJs.tl(k + 2, "+ \", function() { ", str_ajouterErreur(langueNom), "($('#", str_attribuer(langueNom), "_\" + o['pk'] + \"_", str_tri(langueNom), "_", entiteAttribuerTriVar, "')); }\"");
														auteurPageJs.tl(k + 2, "+ \" ); \"); ");
...
//												auteurWebsocket.tl(3, str_suggere(langueNom), classeNomSimple, entiteVarCapitalise, "($('#' + ($(this).val() ? '", str_suggere(langueNom), "' : 'form') + '", classeNomSimple, entiteVarCapitalise, "'), $('#", "list", classeNomSimple, entiteVarCapitalise, "_", classeApiMethodeMethode, "'));");
												auteurWebsocket.tl(3, "$('.", str_suggere(langueNom), entiteVarCapitalise, "').trigger('oninput');");
					...
					s(wJsInit);
					tl(2, "tl(1, ", q("websocket", classeNomSimple, "(); "), ");");
					tl(2, "l(\"});\");");
					tl(1, "}");
					l();
...
//					t(3).l("// contexteAucunNomTrouve : ", contexteAucunNomTrouve);
					...
					tl(3, str_requeteSite(langueNom), "_.set", str_Requete(langueNom), "Pk(o.getPk());");
...
//					tl(2, "if(", str_liste(langueNom), classeNomSimple, " != null && ", str_liste(langueNom), classeNomSimple, ".size() == 1 && params.getJsonObject(\"query\").getString(\"q\").equals(\"*:*\") && params.getJsonObject(\"query\").getJsonArray(\"fq\") == null) {");
					...
					if(!classePageSimple) {
						...
						t(4).s(".a(\"onclick\", \"patch", classeNomSimple, "Vals( [ {name: 'fq', value: 'pk:' + \" + ", str_requeteSite(langueNom), "_.get", str_Requete(langueNom), "Pk() + \" } ], {}, function() { ", str_ajouterLueur(langueNom), "($('#", str_recharger(langueNom), StringUtils.trim(StringUtils.capitalize(contexteCe)), classeGenPageNomSimple, "')); }, function() { ", str_ajouterErreur(langueNom), "($('#", str_recharger(langueNom), StringUtils.trim(StringUtils.capitalize(contexteCe)), classeGenPageNomSimple, "')); }); return false; \")").dfl();
						t(4).e("i").da("class", "fas fa-sync-alt w3-padding-small ").df().dgl("i");
						...
						for(String classeApiMethode : classeApiMethodes) {
							...
							if("application/json".equals(classeApiTypeMediaMethode) && !"GET".equals(classeApiMethodeMethode)) {
								Integer tab = classeApiMethodeMethode.contains("PATCH") || classeApiMethodeMethode.contains("POST") ? 0 : 1;
								...
								{ t(2 + tab).be("div").da("id", classeApiOperationIdMethode, str_Modale(langueNom)).da("class", "w3-modal ").dfl();
									{ t(3 + tab).be("div").da("class", "w3-modal-content w3-card-4 ").dfl();
										{ t(4 + tab).be("header").da("class", "w3-container w3-", contexteCouleur, " ").dfl();
											...
											t(5 + tab).e("h2").da("class", "w3-padding ").df().dsxq(methodeTitreValeurs).dgl("h2");
										} t(4 + tab).bgl("header");
										...
										{ t(4 + tab).be("div").da("class", "w3-container ").dfl();
											...
											if("PATCH".equals(classeApiMethodeMethode)) {
												...
												if("POST".equals(classeApiMethodeMethode))
													...
													tl(6 + tab, ".a(\"onclick\", \"", classeApiOperationIdMethode, "($('#", classeApiOperationIdMethode, str_FormulaireFiltres(langueNom), "'), $('#", classeApiOperationIdMethode, str_FormulaireValeurs(classePageLangueNom), "'), function() {}, function() {}); \")");
												else if("PUT".equals(classeApiMethodeMethode))
												...
												{ t(5 + tab).be("div").da("id", classeApiOperationIdMethode, "Form").dfl();
				...
				if(!classePageSimple) {
					...
					if(contexteIconeGroupe != null && contexteIconeNom != null)
						t(5).s("p.").e("i").da("class", "fa", StringUtils.substring(contexteIconeGroupe, 0, 1), " fa-", contexteIconeNom, " w3-padding-small ").df().dgl("i");
					...
					dfl();
					t(5).s("p.").e("i").da("class", "fas fa-sync-alt w3-padding-small ").df().dgl("i");
					...
					t(2).s("{ p.").e("div").da("class", "w3-cell-row w3-padding ").dfl();
					t(3).s("{ p.").e("div").da("class", "w3-cell ").dfl();
					t(4).s("{ p.").e("span").dfl();
					...
					t(2).s("{ p.").e("div").da("class", "w3-cell-row w3-padding ").dfl();
					t(3).s("{ p.").e("div").da("class", "w3-cell ").dfl();
					t(4).s("{ p.").e("div").da("class", "w3-cell-row ").dfl();
					l();
	
					t(5).s("p.").e("i").da("class", "far fa-search w3-xxlarge w3-cell w3-cell-middle ").df().dgl("i");
					t(5).s("{ p.").e("form").da("action", classeApiUri).s(".a(\"id\", \"", str_suggere(langueNom), "Form", classeNomSimple, "\", id)").da("style", "display: inline-block; width: 100%; ").s(".a(\"onsubmit\", \"event.preventDefault(); window.location.href='", classePageUriMethode, "?q=", classeVarSuggere, ":' + encodeURIComponent($('#", str_suggere(langueNom), classeNomSimple, "\", id, \"').val()); return false; \")").dfl();
					t(6).s("p.").e("input").l();
					t(7).dal("type", "text");
	
					if(contexteRechercherTousNom != null) {
						t(7).dal("placeholder", contexteRechercherTousNom);
					}
	
					t(7).dal("class", str_suggere(langueNom), classeNomSimple, " w3-input w3-border w3-cell w3-cell-middle ");
					t(7).dal("name", str_suggere(langueNom), classeNomSimple);
					t(7).s(".a(\"id\", \"", str_suggere(langueNom), classeNomSimple, "\", id)").l();
					t(7).dal("autocomplete", "off");
					t(7).s(".a(\"oninput\", \"", str_suggere(langueNom), classeNomSimple, StringUtils.capitalize(classeVarSuggere), "( [ { 'name': 'q', 'value': '", classeVarSuggere, ":' + $(this).val() } ], $('#", str_suggere(langueNom), "List", classeNomSimple, "\", id, \"')); \")").l();
					...
					auteurPageJs.l();
					auteurPageJs.tl(0, "function websocket", classeNomSimple, "() {");
					...
					auteurPageJs.tl(3, "var numFound = json['numFound'];");
					auteurPageJs.tl(3, "var numPATCH = json['numPATCH'];");
					auteurPageJs.tl(3, "var percent = Math.floor( numPATCH / numFound * 100 ) + '%';");
					auteurPageJs.tl(3, "var $box = $('<div>').attr('class', 'w3-display-topright w3-quarter box-' + id + ' ').attr('id', 'box-' + id);");
					auteurPageJs.tl(3, "var $margin = $('<div>').attr('class', 'w3-margin ').attr('id', 'margin-' + id);");
					auteurPageJs.tl(3, "var $card = $('<div>').attr('class', 'w3-card ').attr('id', 'card-' + id);");
					...
					auteurPageJs.tl(3, "$('.box-' + id).remove();");
