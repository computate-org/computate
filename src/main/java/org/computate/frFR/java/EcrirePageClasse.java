...
//						t(4).s("}").l();
						...
						auteurPageJs.tl(4, "var pks = json['pks'];");
						auteurPageJs.tl(4, "var empty = json['empty'];");
	//					auteurPageJs.tl(4, "if(!empty) {");
						...
						auteurPageJs.tl(4, "var $card = $('<div>').attr('class', 'w3-card w3-white ').attr('id', 'card-' + id);");
