...
//												auteurWebsocket.tl(3, langueConfig.getString(ConfigCles.var_suggere), classeApiClasseNomSimple, entiteVarCapitalise, "($('#' + ($(this).val() ? '", langueConfig.getString(ConfigCles.var_suggere), "' : 'form') + '", classeApiClasseNomSimple, entiteVarCapitalise, "'), $('#", "list", classeApiClasseNomSimple, entiteVarCapitalise, "_", classeApiMethodeMethode, "'));");
				...
				tl(3, "});");
				tl(3, "$('#site-calendar-box').accordion();");
...
//					auteurPageJs.tl(3, "}");
				...
				auteurPageJs.tl(5, "}");
				auteurPageJs.tl(5, "if(pivot1Vals.length > 0 && pivot1Vals[0].pivotMap) {");
				...
				auteurPageJs.tl(7, "trace['y'] = Object.values(pivot1Counts);");
				auteurPageJs.tl(7, "trace['mode'] = 'lines+markers';");
				auteurPageJs.tl(7, "trace['name'] = pivot1Val;");
				auteurPageJs.tl(7, "var pivot2Map = pivot1.pivotMap;");
				auteurPageJs.tl(7, "var pivot2Vals = Object.keys(pivot2Map);");
				auteurPageJs.tl(7, "pivot2Vals.forEach((pivot2Val) => {");
				auteurPageJs.tl(8, "var pivot2 = pivot2Map[pivot2Val];");
				auteurPageJs.tl(8, "var pivot2Counts = pivot2.ranges[rangeName].counts;");
				auteurPageJs.tl(8, "trace['x'] = Object.keys(pivot2Counts).map(key => key);");
				auteurPageJs.tl(8, "trace['y'] = Object.entries(pivot2Counts).map((key, count) => count);");
				auteurPageJs.tl(8, "trace['mode'] = 'lines';");
				auteurPageJs.tl(6, "});");
