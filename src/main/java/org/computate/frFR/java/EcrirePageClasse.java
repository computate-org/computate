...
//					tl(2, "tl(1, ", q("});"), ");");
			...
			tl(3, "<div class=\"w3-cell w3-cell-top \">");
			t(4, "<label for=\"q", classeNomSimple, "_{{ @key }}\">");
...
//			s(" onchange=\"qChange(this); \"");
			...
			s(" autocomplete=\"off=\"");
			l("/>");
			tl(4, "<div class=\"pageSearchVal w3-tiny \"></div>");
			tl(3, "</div>");
			tl(2, "</div>");
			tl(0, "{{/each}}");
			...
			tl(2, "<div class=\"w3-cell-row \">");
			tl(3, "<div class=\"w3-cell w3-cell-top \">");
			t(4, "<label for=\"q", classeNomSimple, "_", langueConfig.getString(ConfigCles.var_Debut), "\">");
			...
			tl(2, "<div class=\"w3-cell-row \">");
			tl(3, "<div class=\"w3-cell w3-cell-top \">");
			t(4, "<label for=\"q", classeNomSimple, "_", langueConfig.getString(ConfigCles.var_Lignes), "\">");
...
//			l("{{/inline}}");
			...
			s(" class=\"siteSidebarToggle w3-xlarge w3-", contexteCouleur, " \"");
...
//					auteurPageJs.tl(3, "}");
				...
				auteurPageJs.tl(3, "var rangeName;");
				auteurPageJs.tl(3, "var rangeVar;");
				auteurPageJs.tl(3, "var rangeVarFq;");
				auteurPageJs.tl(3, "var rangeCounts;");
				auteurPageJs.tl(3, "var rangeVals;");
				auteurPageJs.tl(3, "if(range) {");
				auteurPageJs.tl(4, "rangeName = range.name;");
				...
				auteurPageJs.tl(3, "} else if(range) {");
