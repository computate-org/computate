...
//												auteurWebsocket.tl(3, langueConfig.getString(ConfigCles.var_suggere), classeApiClasseNomSimple, entiteVarCapitalise, "($('#' + ($(this).val() ? '", langueConfig.getString(ConfigCles.var_suggere), "' : 'form') + '", classeApiClasseNomSimple, entiteVarCapitalise, "'), $('#", "list", classeApiClasseNomSimple, entiteVarCapitalise, "_", classeApiMethodeMethode, "'));");
			...
			t(0, "{{#*inline \"htmHead", classePageNomSimple, "\"}}{{/block}}");
...
//					auteurPageJs.tl(3, "}");
				...
				auteurPageJs.tl(4, "var pivot1Var = pivot1Var", langueConfig.getString(ConfigCles.var_Indexe), ".substring(0, pivot1Var", langueConfig.getString(ConfigCles.var_Indexe), ".indexOf('_'));");
				auteurPageJs.tl(4, "var pivot1VarFq = window.varsFq[pivot1Var] ? window.varsFq[pivot1Var] : 'classSimpleName';");
				...
				auteurPageJs.tl(4, "if(pivot1VarFq.", langueConfig.getString(ConfigCles.var_classeNomSimple), " === 'Point') {");
				...
				auteurPageJs.tl(5, "}");
				auteurPageJs.tl(5, "layout['yaxis'] = {");
				auteurPageJs.tl(6, "title: pivot1VarFq.displayName");
				auteurPageJs.tl(5, "}");
				auteurPageJs.tl(5, "pivot1Vals.forEach((pivot1Val) => {");
				auteurPageJs.tl(6, "var pivot1 = pivot1Map[pivot1Val];");
				auteurPageJs.tl(6, "var pivot1Counts = pivot1.ranges[rangeName].counts;");
				...
				auteurPageJs.tl(6, "trace['y'] = Object.values(pivot1Counts);");
				auteurPageJs.tl(6, "trace['mode'] = 'lines+markers';");
				auteurPageJs.tl(6, "trace['name'] = pivot1Val;");
//				auteurPageJs.tl(6, "var pivot2Map = pivot1.pivotMap;");
//				auteurPageJs.tl(6, "var pivot2Vals = Object.keys(pivot2Map);");
//				auteurPageJs.tl(6, "pivot2Vals.forEach((pivot2Val) => {");
//				auteurPageJs.tl(7, "var pivot2 = pivot2Map[pivot2Val];");
//				auteurPageJs.tl(7, "var pivot2Counts = pivot2.ranges[rangeName].counts;");
//				auteurPageJs.tl(7, "trace['x'] = Object.keys(pivot2Counts).map(key => key);");
//				auteurPageJs.tl(7, "trace['y'] = Object.entries(pivot2Counts).map((key, count) => count);");
//				auteurPageJs.tl(7, "trace['mode'] = 'lines';");
//				auteurPageJs.tl(5, "});");
