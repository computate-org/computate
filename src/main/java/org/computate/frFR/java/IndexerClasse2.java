 ...
 */
public class IndexerClasse2 extends RegarderClasseBase { 
	/**
	...
	protected Boolean stockerListeSolr(SolrInputDocument doc, String nomChamp, Boolean valeurChamp) throws Exception {
		doc.addField(concat(nomChamp, "_", langueNom, "_stored_booleans"), valeurChamp);
		return valeurChamp;
	}
	...
	protected Boolean indexerListeSolr(SolrInputDocument doc, String nomChamp, Boolean valeurChamp) throws Exception {
		doc.addField(concat(nomChamp, "_", langueNom, "_indexed_booleans"), valeurChamp);
		return valeurChamp;
	} 
	...
	protected Date indexerStockerSolr(SolrInputDocument doc, String nomChamp, Date valeurChamp) throws Exception {
		doc.addField(concat(nomChamp, "_", langueNom, "_stored_date"), valeurChamp);
		doc.addField(concat(nomChamp, "_", langueNom, "_indexed_date"), valeurChamp);
		return valeurChamp;
	}
...
//	} 
	...
	public SolrInputDocument indexerClasse(String classeCheminAbsolu, SolrInputDocument classeDoc) throws Exception { 
		...
		String classeNomSimpleGenApiServiceImpl = indexerStockerSolr(classeDoc, "classeNomSimpleGenApiServiceImpl", langueNom, classeNomSimple + "ApiGen");
...
//		classeQdox.getSuperClass().getGenericCanonicalName(); // returns CouvertureGen<DEV>
		...
		String classeCheminGenPage = concat(cheminSrcGenJava, "/", StringUtils.replace(classeNomCanonique, ".", "/"), "PageGen.java");
...
//						}
						...
						if(methodeCommentaire != null) {
							...
							while(entiteOptionsTrouves) {
								...
								String entiteOptionDescription = entiteOptionsRecherche.group(3);
