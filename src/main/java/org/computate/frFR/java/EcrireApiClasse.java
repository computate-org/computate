			...
			for(String classeApiMethode : classeApiMethodes) {
				...
				if(classePageLangueNom == null || classePageLangueNom.equals(classeLangueNom)) {
					...
					if(
						...
						if(StringUtils.containsAny(classeApiMethode, "GET", str_Recherche(classePageLangueNom))) {
					...
					if(classeApiMethode.contains("POST")) {
						...
						tl(9, classeApiOperationIdMethode, str_Reponse(classePageLangueNom), "(", StringUtils.uncapitalize(classeNomSimple), ", d -> {");
						tl(10, "if(d.succeeded()) {");
						tl(11, "LOGGER.info(String.format(\"", classeApiOperationIdMethode, " %s ", str_a_réussi(classePageLangueNom), ". \"));");
						tl(10, "} else {");
						tl(11, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " %s ", str_a_échoué(classePageLangueNom), ". \", d.cause()));");
						...
						tl(18, classeApiOperationIdMethode, str_Reponse(classePageLangueNom), "(", str_liste(classeLangueNom), classeNomSimple, ", g -> {");
						tl(19, "if(g.succeeded()) {");
						tl(20, "LOGGER.info(String.format(\"", classeApiOperationIdMethode, " %s ", str_a_réussi(classePageLangueNom), ". \"));");
						tl(19, "} else {");
						tl(20, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " %s ", str_a_échoué(classePageLangueNom), ". \", g.cause()));");
...
//						else {
							...
							tl(9, classeApiOperationIdMethode, str_Reponse(classePageLangueNom), "(", str_liste(classeLangueNom), classeNomSimple, ", d -> {");
							tl(10, "if(d.succeeded()) {");
							tl(11, "LOGGER.info(String.format(\"", classeApiOperationIdMethode, " %s ", str_a_réussi(classePageLangueNom), ". \"));");
							tl(10, "} else {");
							tl(11, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " %s ", str_a_échoué(classePageLangueNom), ". \", d.cause()));");
...
//						tl(13, "LOGGER.info(String.format(\"{}\", JsonObject.mapFrom(", str_requeteApi(langueNom), ")));");
...

					{
						...
						t(1, "public void ", classeApiOperationIdMethode, str_Reponse(classePageLangueNom), "(");
						s(type, " ", var);
					...
					if(StringUtils.containsAny(classeApiMethode, "POST", "PUT", "PATCH")) {
						...
						if(classeApiMethode.contains("POST")) {
							...
							tl(6, "if(b.succeeded()) {");
							tl(7, str_definir(classeLangueNom), str_Indexer(classePageLangueNom), classeNomSimple, "(", StringUtils.uncapitalize(classeNomSimple), ", c -> {");
							tl(8, "if(c.succeeded()) {");
	...
	//					tl(1, "}");
					...
					if(classeApiMethode.contains("PUT")) {
						...
						tl(4, "futures.add(");
						tl(5, classeApiOperationIdMethode, "Future(", classeApiMethode.contains("PATCH") ? "o" : (str_requeteSite(classeLangueNom) + ", JsonObject.mapFrom(o)"), ", a -> {");
						tl(6, "if(a.succeeded()) {");
						tl(6, "} else {");
						...
						tl(5, "} else {");
						tl(6, str_reponse(classeLangueNom), "200", classeApiMethode, classeNomSimple, "(", str_liste(classeLangueNom), classeNomSimple, ", ", str_gestionnaireEvenements(classeLangueNom), ");");
						tl(5, "}");
						tl(4, "} else {");
						...
						tl(4, "futures.add(");
						tl(5, classeApiOperationIdMethode, "Future(", str_requeteSite(classeLangueNom), ", jsonObject, a -> {");
						tl(6, "if(a.succeeded()) {");
						tl(6, "} else {");
						tl(7, str_erreur(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), ", ", str_gestionnaireEvenements(classeLangueNom), ", a);");
						tl(6, "}");
...
//			tl(9, str_requeteSite(classeLangueNom), "2.set", str_OperationRequete(classeLangueNom), "(", str_operationRequete(classeLangueNom), ");");
			...
			tl(1, "}");
			l();
			tl(1, "public void ", str_recherche(classeLangueNom), classeNomSimple, "Rows(", classePartsListeRecherche.nomSimple(classeLangueNom), "<", classeNomSimple, "> ", str_listeRecherche(classeLangueNom), ", Integer ", str_valeur(classeLangueNom), "Rows) {");
			tl(2, str_listeRecherche(classeLangueNom), ".setRows(", str_valeur(classeLangueNom), "Rows);");
			tl(1, "}");
			l();
			tl(1, "public void ", str_recherche(classeLangueNom), classeNomSimple, "Start(", classePartsListeRecherche.nomSimple(classeLangueNom), "<", classeNomSimple, "> ", str_listeRecherche(classeLangueNom), ", Integer ", str_valeur(classeLangueNom), "Start) {");
			tl(2, str_listeRecherche(classeLangueNom), ".setStart(", str_valeur(classeLangueNom), "Start);");
			tl(1, "}");
			l();
			tl(1, "public void ", str_recherche(classeLangueNom), classeNomSimple, "Var(", classePartsListeRecherche.nomSimple(classeLangueNom), "<", classeNomSimple, "> ", str_listeRecherche(classeLangueNom), ", String var, String ", str_valeur(classeLangueNom), ") {");
...
//				tl(5, "&& !CollectionUtils.containsAny(", str_requeteSite(classeLangueNom), ".get", str_UtilisateurRolesRoyaume(classeLangueNom), "(), roleReads)");
			...
			tl(8, str_recherche(classeLangueNom), classeNomSimple, "Q(", str_listeRecherche(classeLangueNom), ", ", str_entite(classeLangueNom), "Var, ", str_valeur(classeLangueNom), str_Indexe(classeLangueNom), ", ", "var", str_Indexe(classeLangueNom), ");");
...
//			tl(8, "}");
			...
			tl(8, str_recherche(classeLangueNom), classeNomSimple, "Fq(", str_listeRecherche(classeLangueNom), ", ", str_entite(classeLangueNom), "Var, ", str_valeur(classeLangueNom), str_Indexe(classeLangueNom), ", ", "var", str_Indexe(classeLangueNom), ");");
			tl(8, "break;");
			...
			tl(8, "var", str_Indexe(classeLangueNom), " = ", classeNomSimple, ".var", str_Indexe(classeLangueNom), classeNomSimple, "(", str_entite(classeLangueNom), "Var);");
			tl(8, str_recherche(classeLangueNom), classeNomSimple, "Sort(", str_listeRecherche(classeLangueNom), ", ", str_entite(classeLangueNom), "Var, ", str_valeur(classeLangueNom), str_Indexe(classeLangueNom), ", ", "var", str_Indexe(classeLangueNom), ");");
			tl(8, "break;");
//	
//			tl(7, "case \"fl\":");
...
//			tl(8, "break;");
			...
			tl(8, str_recherche(classeLangueNom), classeNomSimple, "Start(", str_listeRecherche(classeLangueNom), ", ", str_valeur(classeLangueNom), "Start);");
			tl(8, "break;");
	
			tl(7, "case \"rows\":");
			tl(8, str_valeur(classeLangueNom), "Rows = (Integer)param", str_Objet(classeLangueNom), ";");
			tl(8, str_recherche(classeLangueNom), classeNomSimple, "Rows(", str_listeRecherche(classeLangueNom), ", ", str_valeur(classeLangueNom), "Rows);");
			tl(8, "break;");
	
			tl(7, "case \"var\":");
			tl(8, "", str_entite(classeLangueNom), "Var = StringUtils.trim(StringUtils.substringBefore((String)param", str_Objet(classeLangueNom), ", \":\"));");
			tl(8, "", str_valeur(classeLangueNom), "", str_Indexe(classeLangueNom), " = URLDecoder.decode(StringUtils.trim(StringUtils.substringAfter((String)param", str_Objet(classeLangueNom), ", \":\")), \"UTF-8\");");
			tl(8, str_recherche(classeLangueNom), classeNomSimple, "Var(", str_listeRecherche(classeLangueNom), ", ", str_entite(classeLangueNom), "Var, ", str_valeur(classeLangueNom), str_Indexe(classeLangueNom), ");");
			tl(8, "break;");
