...
//						tl(5, str_requeteApi(classeLangueNom), ".setNumPATCH(", str_requeteApi(classeLangueNom), ".getNumPATCH() + 1);");
					...
					if(StringUtils.containsAny(classeApiMethode, "POST", str_PUTCopie(classeLangueNom), "PATCH")) {
						...
						if(classeApiMethode.contains("POST")) {
							...
							tl(9, "}");
							tl(9, "SQLConnection ", str_connexionSql(classeLangueNom), " = ", str_requeteSite(classeLangueNom), ".get", str_ConnexionSql(classeLangueNom), "();");
							tl(9, str_connexionSql(classeLangueNom), ".commit(d -> {");
							tl(10, "if(d.succeeded()) {");
							...
							tl(13, "}");
							tl(13, "SQLConnection ", str_connexionSql(classeLangueNom), " = ", str_requeteSite(classeLangueNom), ".get", str_ConnexionSql(classeLangueNom), "();");
							tl(13, str_connexionSql(classeLangueNom), ".commit(f -> {");
							...
							tl(11, str_connexionSql(classeLangueNom), ".commit(e -> {");
							tl(12, "if(e.succeeded()) {");
...
//							tl(3, "page.setPageUrl(\"", siteUrlBase, classeApiUri, "\");");
			...
			tl(8, "if(", str_gestionnaireEvenements(classeLangueNom), " != null)");
			tl(9, str_gestionnaireEvenements(classeLangueNom), ".handle(Future.succeededFuture(", str_reponse(classeLangueNom), "Operation));");
			tl(7, "} else {");
			tl(8, "if(", str_gestionnaireEvenements(classeLangueNom), " != null)");
			tl(9, str_gestionnaireEvenements(classeLangueNom), ".handle(Future.succeededFuture(", str_reponse(classeLangueNom), "Operation));");
			tl(7, "}");
