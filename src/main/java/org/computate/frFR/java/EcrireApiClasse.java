...
//							tl(5, classeLangueConfig.getString(ConfigCles.var_requeteService), ".getParams().getJsonObject(\"query\").put(\"rows\", 100);");
						...
						if(activerRoleAdmin) {
							...
							tl(7, "if(", classeLangueConfig.getString(ConfigCles.var_liste), classeNomSimple, ".getQueryResponse().getResponse().getNumFound() > 1");
						...
						tl(tBase + 7, classeLangueConfig.getString(ConfigCles.var_requeteApi), ".setNumFound(", classeLangueConfig.getString(ConfigCles.var_liste), classeNomSimple, ".getQueryResponse().getResponse().getNumFound());");
						...
						tl(7, classeLangueConfig.getString(ConfigCles.var_requeteApi), ".setNumFound(", classeLangueConfig.getString(ConfigCles.var_liste), classeNomSimple, ".getQueryResponse().getResponse().getNumFound());");
					...
					if(classeApiMethode.contains("PATCH")) {
						...
						tl(4, classeLangueConfig.getString(ConfigCles.var_requeteApi), ".setNumPATCH(", classeLangueConfig.getString(ConfigCles.var_requeteApi), ".getNumPATCH() + ", classeLangueConfig.getString(ConfigCles.var_liste), classeNomSimple, ".getQueryResponse().getResponse().getDocs().size());");
					...
					if(classeApiMethode.equals(classeLangueConfig.getString(ConfigCles.var_PUTCopie))) {
						...
						tl(2, classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.nomSimple(classeLangueNom), " ", classeLangueConfig.getString(ConfigCles.var_requeteSite), " = ", classeLangueConfig.getString(ConfigCles.var_liste), classeNomSimple, ".get", classeLangueConfig.getString(ConfigCles.var_RequeteSite), "_();");
						tl(2, classeLangueConfig.getString(ConfigCles.var_liste), classeNomSimple, ".getList().forEach(o -> {");
						tl(3, classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.nomSimple(classeLangueNom), " ", classeLangueConfig.getString(ConfigCles.var_requeteSite), "2 = ", classeLangueConfig.getString(ConfigCles.var_requeteSite), ".copy();");
						...
						l();
						tl(1, "public Future<Void> ", classeLangueConfig.getString(ConfigCles.var_liste), classeApiMethode, classeNomSimple, "(", classePartsRequeteApi.nomSimple(classeLangueNom), " ", classeLangueConfig.getString(ConfigCles.var_requeteApi), ", ", classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.nomSimple(classeLangueNom), " ", classeLangueConfig.getString(ConfigCles.var_requeteSite), ") {");
						tl(2, "Promise<Void> promise = Promise.promise();");
						tl(2, "List<Future> futures = new ArrayList<>();");
					...
					if(StringUtils.contains(classeApiMethode, "POST")) {
						...
						tl(4, classeLangueConfig.getString(ConfigCles.var_listeRecherche), ".fq(\"", classeApiMethode.equals("PUTImport") ? classeVarInheritClePrimaire + "_docvalues_string" : classeVarClePrimaire + "_docvalues_long", ":\" + SearchTool.escapeQueryChars(body.getString(\"", classeVarClePrimaire, "\")));");
					...
					if(StringUtils.containsAny(classeApiMethode, "POST", classeLangueConfig.getString(ConfigCles.var_PUTCopie), "PATCH")) {
						...
						if(StringUtils.contains(classeApiMethode, "PATCH"))
							tl(2, classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.nomSimple(classeLangueNom), " ", classeLangueConfig.getString(ConfigCles.var_requeteSite), " = o.get", classeLangueConfig.getString(ConfigCles.var_RequeteSite), "_();");
						else if(!StringUtils.containsAny(classeApiMethode, "POST", "PUT"))
							tl(2, classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.nomSimple(classeLangueNom), " ", classeLangueConfig.getString(ConfigCles.var_requeteSite), " = ", uncapitalizeClasseNomSimple, ".get", classeLangueConfig.getString(ConfigCles.var_RequeteSite), "_();");
...
//							tl(2, classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.nomSimple(classeLangueNom), " ", classeLangueConfig.getString(ConfigCles.var_requeteSite), " = ", var, ".get", classeLangueConfig.getString(ConfigCles.var_RequeteSite), "_();");
//
//						tl(2, "try {");
...
//					}
					...
					if(classeApiMethode.contains(classeLangueConfig.getString(ConfigCles.var_Recherche))) {
						if(classePageNomCanoniqueMethode != null) {
							...
							tl(3, "String exception", classeLangueConfig.getString(ConfigCles.var_Recherche), " = Optional.ofNullable(", classeLangueConfig.getString(ConfigCles.var_reponse), classeLangueConfig.getString(ConfigCles.var_Recherche), ".getError()).map(error -> error.getMsg()).orElse(null);");
							tl(3, "List<String> fls = ", classeLangueConfig.getString(ConfigCles.var_liste), classeNomSimple, ".getRequest().getFields();");
							l();
							...
							l();
							tl(3, "SolrResponse.FacetFields facetFields = Optional.ofNullable(", classeLangueConfig.getString(ConfigCles.var_reponse), classeLangueConfig.getString(ConfigCles.var_Recherche), ".getFacetCounts()).map(f -> f.getFacetFields()).orElse(null);");
							tl(3, "if(facetFields != null) {");
							tl(4, "JsonObject facetFieldsJson = new JsonObject();");
							tl(4, "json.put(\"facet_fields\", facetFieldsJson);");
							tl(4, "for(SolrResponse.FacetField facetField : facetFields.getFacets().values()) {");
							tl(5, "String facetFieldVar = StringUtils.substringBefore(facetField.getName(), \"_docvalues_\");");
							tl(5, "JsonObject facetFieldCounts = new JsonObject();");
							tl(5, "facetFieldsJson.put(facetFieldVar, facetFieldCounts);");
							tl(5, "facetField.getCounts().forEach((name, count) -> {");
							tl(6, "facetFieldCounts.put(name, count);");
							tl(5, "});");
							tl(4, "}");
							tl(3, "}");
							l();
							tl(3, "SolrResponse.FacetRanges facetRanges = Optional.ofNullable(", classeLangueConfig.getString(ConfigCles.var_reponse), classeLangueConfig.getString(ConfigCles.var_Recherche), ".getFacetCounts()).map(f -> f.getFacetRanges()).orElse(null);");
							tl(3, "if(facetRanges != null) {");
							tl(4, "JsonObject rangeJson = new JsonObject();");
							tl(4, "json.put(\"facet_ranges\", rangeJson);");
							tl(4, "for(SolrResponse.FacetRange rangeFacet : facetRanges.getRanges().values()) {");
							tl(5, "JsonObject rangeFacetJson = new JsonObject();");
							tl(5, "String rangeFacetVar = StringUtils.substringBefore(rangeFacet.getName(), \"_docvalues_\");");
							...
							tl(5, "rangeFacet.getCounts().forEach((name, count) -> {");
							tl(6, "rangeFacetCountsMap.put(name, count);");
							tl(5, "});");
...
//							tl(5, "}");
							...
							tl(3, "}");
							l();
							tl(3, "SolrResponse.FacetPivots facetPivots = Optional.ofNullable(", classeLangueConfig.getString(ConfigCles.var_reponse), classeLangueConfig.getString(ConfigCles.var_Recherche), ".getFacetCounts()).map(f -> f.getFacetPivots()).orElse(null);");
							tl(3, "if(facetPivots != null) {");
							tl(4, "JsonObject facetPivotJson = new JsonObject();");
							tl(4, "json.put(\"facet_pivot\", facetPivotJson);");
							tl(4, "for(SolrResponse.FacetPivot facetPivot : facetPivots.getPivots().values()) {");
							tl(5, "String[] vars", classeLangueConfig.getString(ConfigCles.var_Indexe), " = facetPivot.getName().trim().split(\",\");");
							...
							tl(6, classeLangueConfig.getString(ConfigCles.var_entite), "Vars[i] = StringUtils.substringBefore(", classeLangueConfig.getString(ConfigCles.var_entite), classeLangueConfig.getString(ConfigCles.var_Indexe), ", \"_docvalues_\");");
							tl(5, "}");
							...
							tl(5, classeLangueConfig.getString(ConfigCles.var_reponse), "Pivot", classeApiMethode, classeNomSimple, "(facetPivot.getPivot(), pivotArray);");
							tl(4, "}");
							tl(3, "}");
							tl(3, "if(exception", classeLangueConfig.getString(ConfigCles.var_Recherche), " != null) {");
							tl(4, "json.put(", q("exception", classeLangueConfig.getString(ConfigCles.var_Recherche)), ", exception", classeLangueConfig.getString(ConfigCles.var_Recherche), ");");
							tl(3, "}");
						}
					}
					else if(classeApiMethode.contains("GET")) {
...
//							tl(3, "page.setPageUrl(\"", siteUrlBase, classeApiUri, "\");");
					...
					if(classeApiMethode.contains(classeLangueConfig.getString(ConfigCles.var_Recherche)) && classePageNomCanoniqueMethode == null) {
						...
						tl(2, "for(SolrResponse.Pivot pivotField : pivots) {");
						...
						tl(3, "String ", classeLangueConfig.getString(ConfigCles.var_entite), "Var = StringUtils.substringBefore(", classeLangueConfig.getString(ConfigCles.var_entite), classeLangueConfig.getString(ConfigCles.var_Indexe), ", \"_docvalues_\");");
						...
						tl(3, "List<SolrResponse.Pivot> pivotFields2 = pivotField.getPivot();");
						tl(3, "if(pivotRanges != null) {");
						tl(4, "JsonObject rangeJson = new JsonObject();");
						tl(4, "pivotJson.put(\"ranges\", rangeJson);");
						tl(4, "for(SolrResponse.PivotRange rangeFacet : pivotRanges) {");
						tl(5, "JsonObject rangeFacetJson = new JsonObject();");
						tl(5, "String rangeFacetVar = StringUtils.substringBefore(rangeFacet.getName(), \"_docvalues_\");");
						tl(5, "rangeJson.put(rangeFacetVar, rangeFacetJson);");
						tl(5, "JsonObject rangeFacetCountsObject = new JsonObject();");
						tl(5, "rangeFacetJson.put(\"counts\", rangeFacetCountsObject);");
						tl(5, "rangeFacet.getCounts().forEach((value, count) -> {");
						tl(6, "rangeFacetCountsObject.put(value, count);");
						tl(5, "});");
						tl(4, "}");
						tl(3, "}");
	...
	public void ecrireGenApiServiceImpl3(String classeLangueNom) throws Exception {
		...
		if(auteurGenApiServiceImpl != null) {
			...
			if(classeApiMethodes.contains("PATCH") || classeApiMethodes.contains("PUT")) {
				l();
				tl(1, "public Future<", classeNomSimple, "> ", classeLangueConfig.getString(ConfigCles.var_creer), classeNomSimple, "(", classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.nomSimple(classeLangueNom), " ", classeLangueConfig.getString(ConfigCles.var_requeteSite), ") {");
				tl(2, "Promise<", classeNomSimple, "> promise = Promise.promise();");
				tl(2, "try {");
				tl(3, "SqlConnection ", classeLangueConfig.getString(ConfigCles.var_connexionSql), " = ", classeLangueConfig.getString(ConfigCles.var_requeteSite), ".get", classeLangueConfig.getString(ConfigCles.var_ConnexionSql), "();");
...
//			tl(3, classeLangueConfig.getString(ConfigCles.var_listeRecherche), ".setParam(\"hl.encoder\", \"html\");");
			...
			// vars //
			//////////
			tl(1, "public Future<ServiceResponse> vars", classeNomSimple, "(", classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.getEtendBase() ? classePartsRequeteSite.getNomSimpleSuperGenerique() : classePartsRequeteSite.nomSimple(classeLangueNom), " ", classeLangueConfig.getString(ConfigCles.var_requeteSite), ") {");
			tl(2, "Promise<ServiceResponse> promise = Promise.promise();");
			tl(2, "try {");
			...
			tl(4, classeLangueConfig.getString(ConfigCles.var_listeRecherche), ".fl(", classeLangueConfig.getString(ConfigCles.var_entite), classeLangueConfig.getString(ConfigCles.var_Liste), ");");
			s(wFacets);
			l();
