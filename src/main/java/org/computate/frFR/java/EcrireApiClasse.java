...
//			auteurGenApiService.l("import ", classeNomEnsemble, ".", classeNomSimple, "ApiServiceVertxEBProxy;");
			...
			auteurGenApiService.l();
			auteurGenApiService.l("/**");
			auteurGenApiService.l(" * ", str_Traduire(langueNom), ": false");
...
//			auteurGenApiService.tl(1, "// Une méthode d'usine pour créer une instance et un proxy. ");
			auteurGenApiService.tl(1, "static void ", str_enregistrer(langueNom), "Service(", classePartsSiteContexte.nomSimple(langueNom), " ", str_siteContexte(langueNom), ", Vertx vertx) {");
			auteurGenApiService.tl(2, "new ServiceBinder(vertx).setAddress(", q(langueNom, classeNomSimple), ").register(", classeNomSimpleGenApiService, ".class, new ", classeNomSimpleApiServiceImpl, "(", str_siteContexte(langueNom), "));");
			auteurGenApiService.tl(1, "}");
			auteurGenApiService.l();
//			auteurGenApiService.tl(1, "// Une méthode d'usine pour créer une instance et un proxy. ");
			auteurGenApiService.tl(1, "static ", classeNomSimpleGenApiService, " ", str_creer(langueNom), "(", classePartsSiteContexte.nomSimple(langueNom), " ", str_siteContexte(langueNom), ", Vertx vertx) {");
			auteurGenApiService.tl(2, "return new ", classeNomSimpleApiServiceImpl, "(", str_siteContexte(langueNom), ");");
			auteurGenApiService.tl(1, "}");
			auteurGenApiService.l();
			auteurGenApiService.tl(1, "// Une méthode d'usine pour créer une instance et un proxy. ");
			auteurGenApiService.tl(1, "static ", classeNomSimpleGenApiService, " ", str_creer(langueNom), "Proxy(Vertx vertx, String ", str_addresse(langueNom), ") {");
			auteurGenApiService.tl(2, "return new ", classeNomSimpleGenApiService, "VertxEBProxy(vertx, ", str_addresse(langueNom), ");");
			auteurGenApiService.tl(1, "}");
			auteurGenApiService.l();
			for(String classeApiMethode : classeApiMethodes) {
				...
				if(classePageLangueNom == null || classePageLangueNom.equals(langueNom)) {
					if(classePageNomCanoniqueMethode != null) {
						...
						auteurGenApiService.l("OperationRequest ", str_operationRequete(langueNom), ", Handler<AsyncResult<OperationResponse>> ", str_gestionnaireEvenements(langueNom), ");");
					}
...
//			auteurGenApiService.l("import ", classeNomEnsemble, ".", classeNomSimple, "ApiServiceVertxEBProxy;");
								...
								if(BooleanUtils.isTrue(entiteAttribuer)) {
									if(StringUtils.equals(entiteNomCanonique, List.class.getCanonicalName()) || StringUtils.equals(entiteNomCanonique, ArrayList.class.getCanonicalName())) {
										...
										if(StringUtils.compare(entiteVar, entiteAttribuerVar) <= 0) {
											...
											tl(tBase + 3, "patchSqlParams.addAll(Arrays.asList(", q(entiteVar), ", ", classeVarClePrimaire, ", ", q(entiteAttribuerVar), ", ", str_requete(langueNom), "Json.get", entiteListeNomSimpleVertxJson, "(", str_methodeNom(langueNom), ")", "));");
											...
											tl(tBase + 3, "patchSqlParams.addAll(Arrays.asList(", q(entiteVar), ", ", classeVarClePrimaire, ", ", q(entiteAttribuerVar), ", ", str_requete(langueNom), "Json.get", entiteNomSimpleVertxJson, "(", str_methodeNom(langueNom), ")", "));");
					
											tl(tBase + 3, "for(Integer i = 0; i <  set", entiteVarCapitalise, "", str_Valeurs(langueNom), ".size(); i++) {");
											tl(tBase + 4, "patchSql.append(", classePartsSiteContexte.nomSimple(langueNom), ".SQL_addA);");
											tl(tBase + 4, "patchSqlParams.set(Arrays.asList(", q(entiteVar), ", ", classeVarClePrimaire, ", ", q(entiteAttribuerVar), ", addAll", entiteVarCapitalise, "", str_Valeurs(langueNom), ".get", entiteListeNomSimpleVertxJson, "(i)", "));");
											tl(tBase + 3, "}");
										}
										else {
											tl(tBase + 2, "case \"add", entiteVarCapitalise, "\":");
											...
											tl(tBase + 3, "patchSqlParams.addAll(Arrays.asList(", q(entiteAttribuerVar), ", ", str_requete(langueNom), "Json.get", entiteListeNomSimpleVertxJson, "(", str_methodeNom(langueNom), ")", ", ", q(entiteVar), ", ", classeVarClePrimaire, "));");
			...
			for(String classeApiMethode : classeApiMethodes) {
				...
				if(classePageLangueNom == null || classePageLangueNom.equals(langueNom)) {
					...
					if(classeApiMethode.contains("POST")) {
						...
						tl(14, "});");
						tl(13, "} else {");
						tl(14, "", str_erreur(langueNom), "", classeNomSimple, "(", str_requeteSite(langueNom), ", ", str_gestionnaireEvenements(langueNom), ", e);");
						tl(13, "}");
						tl(12, "});");
						tl(11, "}");
						tl(10, "} else {");
	...
	//					tl(1, "}");
					...
					if(classeApiMethode.contains("PATCH")) {
						...
						tl(5, "a -> ", str_definir(langueNom), "", classeApiMethode, classeNomSimple, "(a).compose(");
						tl(6, "b -> ", str_indexer(langueNom), "", classeApiMethode, classeNomSimple, "(b)");
						tl(5, ")");
						tl(4, ")");
						tl(3, ");");
						tl(2, "});");
						...
						tl(5, ", patchAsync");
						tl(3, "-> {");
						tl(4, "o2.set", str_RequeteSite(langueNom), "_(o.get", str_RequeteSite(langueNom), "_());");
						...
						tl(1, "}");
						l();
						tl(1, "public Future<", classeNomSimple, "> ", str_definir(langueNom), "", classeApiMethode, classeNomSimple, "(", classeNomSimple, " o) {");
						tl(2, "Future<", classeNomSimple, "> future = Future.future();");
						tl(2, "try {");
						tl(3, "", classePartsRequeteSite.nomSimple(langueNom), " ", str_requeteSite(langueNom), " = o.get", str_RequeteSite(langueNom), "_();");
						tl(3, "SQLConnection ", str_connexionSql(langueNom), " = ", str_requeteSite(langueNom), ".get", str_ConnexionSql(langueNom), "();");
						...
						tl(1, "}");
						l();
						tl(1, "public Future<Void> ", str_indexer(langueNom), "", classeApiMethode, classeNomSimple, "(", classeNomSimple, " o) {");
						tl(2, "Future<Void> future = Future.future();");
						tl(2, "try {");
						tl(3, "o.", str_initLoin(langueNom), "", str_PourClasse(langueNom), "(o.get", str_RequeteSite(langueNom), "_());");
...
//							tl(3, "page.setPageUrl(\"", siteUrlBase, classeApiUri, "\");");
							...
							l();
							tl(3, "w.l(\"{\");");
							tl(3, "w.tl(1, ", q(q(str_numCommence(langueNom)), ": "), ", ", str_numCommence(langueNom), ");");
							tl(3, "w.tl(1, ", q(", ", q(str_numTrouve(langueNom)), ": "), ", ", str_numTrouve(langueNom), ");");
							tl(3, "w.tl(1, ", q(", ", q(str_numRetourne(langueNom)), ": "), ", ", str_numRetourne(langueNom), ");");
							tl(3, "w.tl(1, ", q(", ", q(str_tempsRecherche(langueNom)), ": "), ", w.q(", str_tempsRecherche(langueNom), "));");
							tl(3, "w.tl(1, ", q(", ", q(str_tempsTransmission(langueNom)), ": "), ", w.q(", str_tempsTransmission(langueNom), "));");
							tl(3, "w.tl(1, ", q(", ", q("", str_liste(langueNom), ""), ": ["), ");");
		...
		//					tl(4, "List<String> champNoms = new ArrayList<>(", str_documentSolr(langueNom), ".getFieldNames());");
							l();
							tl(4, "w.t(2);");
							tl(4, "if(i > 0)");
							tl(5, "w.s(", q(", "), ");");
		...
		//					tl(4, "}");
							...
							tl(4, "w.tl(1, ", q(", ", q("exception", str_Recherche(langueNom), ""), ": "), ", w.q(exception", str_Recherche(langueNom), ".getMessage()));");
							tl(3, "}");
							tl(3, "w.l(\"}\");");
						}
					}
...
//							tl(3, "page.setPageUrl(\"", siteUrlBase, classeApiUri, "\");");
		...
		//					tl(4, "}");
					...
					if((classeApiMethode.contains("GET") || classeApiMethode.contains(str_Recherche(langueNom))) && classePageNomCanoniqueMethode != null) {
						...
						tl(3, "", str_gestionnaireEvenements(langueNom), ".handle(Future.succeededFuture(OperationResponse.completedWithJson(buffer)));");
					}
			...
			tl(6, "});");
			tl(5, "} else {");
			tl(6, "", str_gestionnaireEvenements(langueNom), ".handle(Future.failedFuture(sqlAsync.cause()));");
			tl(5, "}");
			tl(4, "});");
			tl(3, "}");
			tl(2, "} catch(Exception e) {");
...
//					tl(4, "", str_entite(langueNom), "", str_Valeur(langueNom), " = Optional.ofNullable(", str_documentSolr(langueNom), ".getFieldValues(", q(", str_entite(langueNom), "Var, "_stored", ", str_entite(langueNom), "SuffixeType), ")).map(Collection<Object>::stream).orElseGet(Stream::empty).findFirst().orElse(null);");
			...
			tl(10, "}");
			tl(9, "} else {");
			tl(10, "", str_gestionnaireEvenements(langueNom), ".handle(Future.failedFuture(", str_definir(langueNom), "Async.cause()));");
			tl(9, "}");
			tl(8, "});");
			...
			tl(8, "} else {");
			tl(9, "", str_gestionnaireEvenements(langueNom), ".handle(Future.failedFuture(", str_definir(langueNom), "Async.cause()));");
			tl(8, "}");
			tl(7, "});");

			tl(6, "}");
			tl(5, "} else {");
			tl(6, "", str_gestionnaireEvenements(langueNom), ".handle(Future.failedFuture(selectCAsync.cause()));");
			tl(5, "}");
			tl(4, "});");
			tl(3, "}");
			tl(2, "} catch(Exception e) {");
			...
			tl(4, "pageUri = ", str_classeApiUriMethode(langueNom), " + ", q("/"), " + id;");
			tl(4, "", str_liste(langueNom), "", str_Recherche(langueNom), ".addFilterQuery(\"pageUri_indexed_string:\" + ClientUtils.escapeQueryChars(pageUri));");
			tl(3, "}");
			l();
...
//			tl(8, "}");
			...
			tl(3, "-> {");
			tl(4, "if(", str_attribuer(langueNom), "Async.succeeded()) {");
			tl(5, "if(", str_attribuer(langueNom), "Async.result() != null) {");
			tl(6, "for(JsonArray definition : ", str_attribuer(langueNom), "Async.result().getResults()) {");
			tl(7, "o.", str_attribuer(langueNom), "", str_PourClasse(langueNom), "(definition.getString(0), definition.getString(1));");
			tl(6, "}");
			tl(5, "}");
			tl(5, "", str_gestionnaireEvenements(langueNom), ".handle(Future.succeededFuture());");
			tl(4, "} else {");
			tl(5, "", str_gestionnaireEvenements(langueNom), ".handle(Future.failedFuture(", str_attribuer(langueNom), "Async.cause()));");
			tl(4, "}");
			tl(3, "});");
			tl(2, "} catch(Exception e) {");
			tl(3, "", str_gestionnaireEvenements(langueNom), ".handle(Future.failedFuture(e));");
