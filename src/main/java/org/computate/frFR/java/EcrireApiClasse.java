			...
			for(String classeApiMethode : classeApiMethodes) {
				...
				if(classePageLangueNom == null || classePageLangueNom.equals(classeLangueNom)) {
					...
					if(StringUtils.containsAny(classeApiMethode, "POST", "PUT", "PATCH"))
						auteurGenApiService.s("" , StringUtils.equals(classeApiTypeMediaRequeteMethode, "application/json") ? "JsonObject" : "String", " body, ");
					auteurGenApiService.l("ServiceRequest ", i18nGlobale.getString(I18n.var_requeteService), ", Handler<AsyncResult<ServiceResponse>> ", i18nGlobale.getString(I18n.var_gestionnaireEvenements), ");");
					if(StringUtils.containsAny(classeApiMethode, "POST", "PUTImport", i18nGlobale.getString(I18n.var_PUTFusion), "PATCH")) {
							...
							if(classeSauvegarde && BooleanUtils.isTrue(entiteAttribuer)) {
								...
								if(StringUtils.compare(entiteVar, entiteAttribuerVar) < 0) {
									if("array".equals(entiteTypeJson) && "array".equals(entiteAttribuerTypeJson)) {
										...
										tl(9, "}");
										tl(9, "sql(", i18nGlobale.getString(I18n.var_requeteSite), ").insertInto(", classeNomSimple, ".class, ", classeNomSimple, ".VAR_", entiteVar, ", ", entiteAttribuerNomSimple, ".class, ", entiteAttribuerNomSimple, ".VAR_", entiteAttribuerVar, ").values(pk, pk2).onSuccess(a -> {");
									...
									if("array".equals(entiteTypeJson) && "array".equals(entiteAttribuerTypeJson)) {
										...
										tl(10, "classes.add(\"", entiteAttribuerNomSimple, "\");");
										tl(9, "}");
										tl(9, "sql(", i18nGlobale.getString(I18n.var_requeteSite), ").insertInto(", entiteAttribuerNomSimple, ".class, ", entiteAttribuerNomSimple, ".VAR_", entiteAttribuerVar, ", ", classeNomSimple, ".class, ", classeNomSimple, ".VAR_", entiteVar, ").values(pk2, pk).onSuccess(a -> {");
										tl(10, "promise2.complete();");
										tl(9, "}).onFailure(ex -> {");
										tl(10, "promise2.fail(ex);");
										tl(9, "});");
								...
								if(BooleanUtils.isTrue(entiteAttribuer)) {
									...
									if(StringUtils.compare(entiteVar, entiteAttribuerVar) < 0) {
										...
										if("array".equals(entiteTypeJson) && "array".equals(entiteAttribuerTypeJson)) {
											...
											tl(10, "classes.add(\"", entiteAttribuerNomSimple, "\");");
											tl(9, "}");
											tl(9, "sql(", i18nGlobale.getString(I18n.var_requeteSite), ").insertInto(", entiteAttribuerNomSimple, ".class, ", entiteAttribuerNomSimple, ".VAR_", entiteAttribuerVar, ", ", classeNomSimple, ".class, ", classeNomSimple, ".VAR_", entiteVar, ").values(pk, pk2).onSuccess(a -> {");
											tl(10, "promise2.complete();");
											tl(9, "}).onFailure(ex -> {");
											tl(10, "promise2.fail(ex);");
											tl(9, "});");
				...
				if(classePageLangueNom == null || classePageLangueNom.equals(classeLangueNom)) {
					...
					if(
						...
						if(authPolitiqueGranulee) {
							...
							tl(6, StringUtils.containsAny(classeApiMethode, "POST", "PUT", "PATCH") ? "||" : "&&", " !Optional.ofNullable(Optional.ofNullable(config.getString(ComputateConfigKeys.", i18nGlobale.getString(I18n.var_AUTH_ROLE_LIRE_REQUIS), " + \"_", classeNomSimple, "\")).orElse(config.getString(ComputateConfigKeys.", i18nGlobale.getString(I18n.var_AUTH_ROLE_REQUIS), " + \"_", classeNomSimple, "\"))).map(v -> RoleBasedAuthorization.create(v).match(", i18nGlobale.getString(I18n.var_requeteSite), ".get", i18nGlobale.getString(I18n.var_Utilisateur), "())).orElse(false)");
							tl(6, ") {");
					...
					if(classeApiMethode.contains("POST")) {
						...
						if(activerRoleAdmin) {
							tBase = 1;
							tl(8, "if(", i18nGlobale.getString(I18n.var_liste), classeNomSimple, ".getResponse().getResponse().getNumFound() > 1");
							tl(10, "&& !Optional.ofNullable(config.getString(ComputateConfigKeys.", i18nGlobale.getString(I18n.var_AUTH_ROLE_REQUIS), " + \"_", classeNomSimple, "\")).map(v -> RoleBasedAuthorization.create(v).match(", i18nGlobale.getString(I18n.var_requeteSite), ".get", i18nGlobale.getString(I18n.var_Utilisateur), "())).orElse(false)");
							tl(10, ") {");
							tl(9, "String message = String.format(\"", i18nGlobale.getString(I18n.str_roles_requis), "\" + config.getString(ComputateConfigKeys.", i18nGlobale.getString(I18n.var_AUTH_ROLE_REQUIS), " + \"_", classeNomSimple, "\"));");
							tl(9, "LOG.error(message);");
							tl(9, i18nGlobale.getString(I18n.var_erreur), "(", i18nGlobale.getString(I18n.var_requeteSite), ", ", i18nGlobale.getString(I18n.var_gestionnaireEvenements), ", new RuntimeException(message));");
							tl(8, "} else {");
							l();
						} else {
							tBase = 0;
					...
					if(StringUtils.contains(classeApiMethode, "POST")) {
						...
						tl(2, i18nGlobale.getString(I18n.var_utilisateur), "(", i18nGlobale.getString(I18n.var_requeteService), ", ", classePartsRequeteSite.nomSimple(classeLangueNom), ".class, ", classePartsUtilisateurSite.nomSimple(classeLangueNom), ".class, ", classePartsUtilisateurSite.nomSimple(classeLangueNom), ".get", i18nGlobale.getString(I18n.var_ClasseApiAddresse), "(), \"post", classePartsUtilisateurSite.nomSimple(classeLangueNom), "Future\", \"patch", classePartsUtilisateurSite.nomSimple(classeLangueNom), "Future\").onSuccess(", i18nGlobale.getString(I18n.var_requeteSite), " -> {");
						tl(3, classePartsRequeteApi.nomSimple(classeLangueNom), " ", i18nGlobale.getString(I18n.var_requeteApi), " = new ", classePartsRequeteApi.nomSimple(classeLangueNom), "();");
						tl(3, i18nGlobale.getString(I18n.var_requeteApi), ".setRows(1L);");
						tl(3, i18nGlobale.getString(I18n.var_requeteApi), ".setNumFound(1L);");
						tl(3, i18nGlobale.getString(I18n.var_requeteApi), ".setNumPATCH(0L);");
						tl(3, i18nGlobale.getString(I18n.var_requeteApi), ".", i18nGlobale.getString(I18n.var_initLoin), classePartsRequeteApi.nomSimple(classeLangueNom), "(", i18nGlobale.getString(I18n.var_requeteSite), ");");
						tl(3, i18nGlobale.getString(I18n.var_requeteSite), ".set", i18nGlobale.getString(I18n.var_RequeteApi), "_(", i18nGlobale.getString(I18n.var_requeteApi), ");");
						tl(3, "if(Optional.ofNullable(", i18nGlobale.getString(I18n.var_requeteService), ".getParams()).map(p -> p.getJsonObject(\"query\")).map( q -> q.getJsonArray(\"var\")).orElse(new JsonArray()).stream().filter(s -> \"", i18nGlobale.getString(I18n.var_recharger), ":false\".equals(s)).count() > 0L) {");
						tl(4, i18nGlobale.getString(I18n.var_requeteSite), ".get", i18nGlobale.getString(I18n.var_Requete), "Vars().put( \"", i18nGlobale.getString(I18n.var_recharger), "\", \"false\" );");
						tl(3, "}");
						tl(3, classeApiOperationIdMethode, "Future(", i18nGlobale.getString(I18n.var_requeteSite), ", false).onSuccess(o -> {");
						tl(4, i18nGlobale.getString(I18n.var_gestionnaireEvenements), ".handle(Future.succeededFuture(ServiceResponse.completedWithJson(Buffer.buffer(JsonObject.mapFrom(o).encodePrettily()))));");
						tl(3, "}).onFailure(ex -> {");
...
//							tl(10, "}");
					...
					if(StringUtils.containsAny(classeApiMethode, "POST", i18nGlobale.getString(I18n.var_PUTCopie), "PATCH")) {
						l();
...
//			tl(3, classeLangueConfig.getString(ConfigCles.var_listeRecherche), ".setParam(\"hl.encoder\", \"html\");");
			...
			if(classeRoles.size() > 0 && (classeRoleSession || classeRoleUtilisateur)) {
				...
				tl(6, "+ \" OR ", i18nGlobale.getString(I18n.var_utilisateur), i18nGlobale.getString(I18n.var_Cle), "s_docvalues_longs:\" + Optional.ofNullable(", i18nGlobale.getString(I18n.var_requeteSite), ".get", i18nGlobale.getString(I18n.var_Utilisateur), i18nGlobale.getString(I18n.var_Cle), "()).orElse(0L));");
				tl(3, "}");
				...
				tl(4, "+ \" OR ", i18nGlobale.getString(I18n.var_utilisateur), i18nGlobale.getString(I18n.var_Cle), "s_docvalues_longs:\" + Optional.ofNullable(", i18nGlobale.getString(I18n.var_requeteSite), ".get", i18nGlobale.getString(I18n.var_Utilisateur), i18nGlobale.getString(I18n.var_Cle), "()).orElse(0L));");
			}
			l();
...
//			tl(8, langueConfig.getString(ConfigCles.var_liste), langueConfig.getString(ConfigCles.var_Recherche), ".addField(var", langueConfig.getString(ConfigCles.var_Indexe), ");");
			...
			if(classeModele) {
				...
				if(wAttribuerSql.getEmpty()) {
					...
					tl(7, "o.", i18nGlobale.getString(I18n.var_attribuer), i18nGlobale.getString(I18n.var_PourClasse), "(definition.getString(1), definition.getLong(0));");
					tl(6, "}");
					tl(5, "}");
					tl(5, "promise.complete();");
					tl(4, "} catch(Exception ex) {");
