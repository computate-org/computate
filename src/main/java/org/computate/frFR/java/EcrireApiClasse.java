			...
			for(String classeApiMethode : classeApiMethodes) {
				...
				if(classePageLangueNom == null || classePageLangueNom.equals(classeLangueNom)) {
					...
					if(classeApiMethode.contains("POST")) {
						...
						tl(14, "List<String> roles2 = Arrays.asList(\"SiteAdmin\");");
						tl(14, "if(");
						tl(16, "!CollectionUtils.containsAny(", str_requeteSite(classeLangueNom), ".get", str_UtilisateurRolesRessource(classeLangueNom), "(), roles2)");
						tl(16, "&& !CollectionUtils.containsAny(", str_requeteSite(classeLangueNom), ".get", str_UtilisateurRolesRoyaume(classeLangueNom), "(), roles2)");
						tl(16, ") {");
						tl(15, str_gestionnaireEvenements(classeLangueNom), ".handle(Future.succeededFuture(");
						tl(16, "new OperationResponse(401, \"UNAUTHORIZED\", ");
						tl(17, "Buffer.buffer().appendString(");
						tl(18, "new JsonObject()");
						tl(19, ".put(\"errorCode\", \"401\")");
						tl(19, ".put(\"errorMessage\", \"", str_roles_requis(classeLangueNom), "\" + String.join(\", \", roles2))");
						tl(19, ".encodePrettily()");
						tl(18, "), new CaseInsensitiveHeaders()");
						tl(16, ")");
						tl(15, "));");
						tl(14, "}");
						tl(13, "}");
