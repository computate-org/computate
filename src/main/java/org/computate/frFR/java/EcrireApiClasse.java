		...
		if(auteurGenApiServiceImpl != null) {
			...
			for(String classeApiMethode : classeApiMethodes) {
				...
				if(classePageLangueNom == null || classePageLangueNom.equals(classeLangueNom)) {
					...
					tl(3, str_utilisateur(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), ", b -> {");
					tl(4, "if(b.succeeded()) {");
					...
					if(classeApiMethode.contains("POST")) {
						...
						tl(5, classeApiOperationIdMethode, "Future(", str_requeteSite(classeLangueNom), ", false, c -> {");
						tl(6, "if(c.succeeded()) {");
						tl(7, classeNomSimple, " ", StringUtils.uncapitalize(classeNomSimple), " = c.result();");
						tl(7, str_requeteApi(classeLangueNom), ".setPk(", StringUtils.uncapitalize(classeNomSimple), ".getPk());");
						tl(7, classeApiOperationIdMethode, str_Reponse(classeLangueNom), "(", StringUtils.uncapitalize(classeNomSimple), ", d -> {");
						tl(9, "if(d.succeeded()) {");
						tl(9, str_gestionnaireEvenements(classeLangueNom), ".handle(Future.succeededFuture(d.result()));");
						tl(9, "LOGGER.info(String.format(\"", classeApiOperationIdMethode, " ", str_a_réussi(classeLangueNom), ". \"));");
						tl(8, "} else {");
						tl(9, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " ", str_a_échoué(classeLangueNom), ". \", d.cause()));");
						...
						tl(7, "});");
						tl(6, "} else {");
						tl(7, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " ", str_a_échoué(classeLangueNom), ". \", c.cause()));");
						tl(7, str_erreur(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), ", ", str_gestionnaireEvenements(classeLangueNom), ", c);");
						tl(6, "}");
						tl(5, "});");
					}
						...
						tl(7, "WorkerExecutor ", str_executeurTravailleur(classeLangueNom), " = ", str_siteContexte(classeLangueNom), ".get", str_ExecuteurTravailleur(classeLangueNom), "();");
						tl(7, str_executeurTravailleur(classeLangueNom), ".executeBlocking(");
						tl(8, "blockingCodeHandler -> {");
						tl(9, classePartsRequeteSite.nomSimple(classeLangueNom), " ", str_requeteSite(classeLangueNom), "2 = ", str_generer(classeLangueNom), classePartsRequeteSite.nomSimple(classeLangueNom), str_Pour(classeLangueNom), classeNomSimple, "(", str_siteContexte(classeLangueNom), ", ", str_operationRequete(classeLangueNom), ", body);");
						tl(9, "try {");
						tl(10, str_recherche(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), "2, false, true, ", q(classeApiUriMethode), ", ", q(classeApiMethode), ", d -> {");
						...
						if(classeVarModifie == null) {
							tl(12, "String dt = DateTimeFormatter.ofPattern(\"yyyy-MM-dd'T'HH:mm:ss.SSS'Z'\").format(ZonedDateTime.ofInstant(ZonedDateTime.now().toInstant(), ZoneId.of(\"UTC\")).minusNanos(1000));");
						}
						else {
							tl(12, "SimpleOrderedMap facets = (SimpleOrderedMap)Optional.ofNullable(", str_liste(classeLangueNom), classeNomSimple, ".getQueryResponse()).map(QueryResponse::getResponse).map(r -> r.get(\"facets\")).orElse(null);");
							tl(12, "Date date = null;");
							tl(12, "if(facets != null)");
							tl(13, "date = (Date)facets.get(\"max_", classeVarModifie, "\");");
							tl(12, "String dt;");
							tl(12, "if(date == null)");
							tl(13, "dt = DateTimeFormatter.ofPattern(\"yyyy-MM-dd'T'HH:mm:ss.SSS'Z'\").format(ZonedDateTime.ofInstant(ZonedDateTime.now().toInstant(), ZoneId.of(\"UTC\")).minusNanos(1000));");
							tl(12, "else");
							tl(13, "dt = DateTimeFormatter.ofPattern(\"yyyy-MM-dd'T'HH:mm:ss.SSS'Z'\").format(ZonedDateTime.ofInstant(date.toInstant(), ZoneId.of(\"UTC\")));");
							tl(12, str_liste(classeLangueNom), classeNomSimple, ".addFilterQuery(String.format(\"", classeVarModifie, "_indexed_date:[* TO %s]\", dt));");
						}
						l();
						tl(12, classeNomSimple, " o = ", str_liste(classeLangueNom), classeNomSimple, ".getList().stream().findFirst().orElse(null);");
						tl(12, "sql", str_Connexion(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), "2, e -> {");
						tl(13, "if(e.succeeded()) {");
						tl(14, "try {");
						tl(15, str_liste(classeLangueNom), classeApiMethode, classeNomSimple, "(", str_requeteApi(classeLangueNom), ", ", str_liste(classeLangueNom), classeNomSimple, classeApiMethode.contains("PATCH") ? ", dt" : "", ", f -> {");
						tl(16, "if(f.succeeded()) {");
						tl(17, classeApiOperationIdMethode, str_Reponse(classeLangueNom), "(", str_requeteSite(classeLangueNom), "2, g -> {");
						tl(28, "if(g.succeeded()) {");
						tl(19, "LOGGER.info(String.format(\"", classeApiOperationIdMethode, " ", str_a_réussi(classeLangueNom), ". \"));");
						tl(19, "blockingCodeHandler.handle(Future.succeededFuture(g.result()));");
						tl(18, "} else {");
						tl(19, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " ", str_a_échoué(classeLangueNom), ". \", g.cause()));");
						tl(19, str_erreur(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), "2, null, g);");
						tl(18, "}");
						tl(17, "});");
						tl(16, "} else {");
						tl(17, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " ", str_a_échoué(classeLangueNom), ". \", f.cause()));");
						tl(17, str_erreur(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), "2, null, f);");
						tl(16, "}");
						tl(15, "});");
						tl(14, "} catch(Exception ex) {");
						tl(15, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " ", str_a_échoué(classeLangueNom), ". \", ex));");
						tl(15, str_erreur(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), "2, null, Future.failedFuture(ex));");
						tl(14, "}");
						tl(13, "} else {");
						tl(14, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " ", str_a_échoué(classeLangueNom), ". \", e.cause()));");
						tl(14, str_erreur(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), "2, null, e);");
						tl(13, "}");
						tl(12, "});");
						tl(11, "} else {");
						tl(12, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " ", str_a_échoué(classeLangueNom), ". \", d.cause()));");
						tl(12, str_erreur(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), "2, null, d);");
						tl(11, "}");
						tl(10, "});");
						tl(9, "} catch(Exception ex) {");
						tl(10, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " ", str_a_échoué(classeLangueNom), ". \", ex));");
						tl(10, str_erreur(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), "2, null, Future.failedFuture(ex));");
						tl(9, "}");
						tl(8, "}, resultHandler -> {");
						tl(8, "}");
						tl(7, ");");
						...
						tl(5, str_recherche(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), ", false, true, ", q(classeApiUriMethode), ", ", q(classeApiMethode), ", c -> {");
						tl(6, "if(c.succeeded()) {");
						...
						tl(10, "JsonArray jsonArray = Optional.ofNullable(", str_requeteSite(classeLangueNom), "2.get", str_ObjetJson(classeLangueNom), "()).map(o -> o.getJsonArray(\"list\")).orElse(new JsonArray());");
						tl(10, str_requeteApi(classeLangueNom), ".setRows(jsonArray.size());");
						tl(10, str_requeteApi(classeLangueNom), ".setNumFound(new Integer(jsonArray.size()).longValue());");
						...
						tl(10, str_requeteSite(classeLangueNom), "2.getVertx().eventBus().publish(\"websocket", classeNomSimple, "\", JsonObject.mapFrom(", str_requeteApi(classeLangueNom), ").toString());");
						tl(10, "sql", str_Connexion(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), "2, d -> {");
						tl(11, "if(d.succeeded()) {");
						tl(12, str_liste(classeLangueNom), classeApiMethode, classeNomSimple, "(", str_requeteApi(classeLangueNom), ", ", str_requeteSite(classeLangueNom), "2, e -> {");
						tl(13, "if(e.succeeded()) {");
						tl(14, classeApiOperationIdMethode, str_Reponse(classeLangueNom), "(", str_requeteSite(classeLangueNom), "2, f -> {");
						tl(15, "if(f.succeeded()) {");
						tl(16, "LOGGER.info(String.format(\"", classeApiOperationIdMethode, " ", str_a_réussi(classeLangueNom), ". \"));");
						tl(16, "blockingCodeHandler.handle(Future.succeededFuture(f.result()));");
						tl(15, "} else {");
						tl(16, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " ", str_a_échoué(classeLangueNom), ". \", f.cause()));");
						tl(16, str_erreur(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), "2, null, f);");
						tl(15, "}");
						tl(14, "});");
						tl(13, "} else {");
						tl(14, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " ", str_a_échoué(classeLangueNom), ". \", e.cause()));");
						...
						tl(6, "if(c.succeeded()) {");
						tl(7, str_gestionnaireEvenements(classeLangueNom), ".handle(Future.succeededFuture(c.result()));");
						tl(7, "LOGGER.info(String.format(\"", classeApiOperationIdMethode, " ", str_a_réussi(classeLangueNom), ". \"));");
						tl(6, "} else {");
						tl(7, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " ", str_a_échoué(classeLangueNom), ". \", c.cause()));");
						tl(7, str_erreur(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), ", ", str_gestionnaireEvenements(classeLangueNom), ", c);");
						tl(6, "}");
					...
					tl(4, "} else {");
					tl(5, "LOGGER.error(String.format(\"", classeApiOperationIdMethode, " ", str_a_échoué(classeLangueNom), ". \", b.cause()));");
					tl(5, str_erreur(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), ", ", str_gestionnaireEvenements(classeLangueNom), ", b);");
					tl(4, "}");
					tl(3, "});");
