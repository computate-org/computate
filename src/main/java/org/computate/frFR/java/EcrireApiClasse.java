...
//	}
  ...
  public void ecrireGenApiService(String classeLangueNom) throws Exception {
    ...
    if(auteurGenApiService != null) {
      ...
      auteurGenApiService.l("public interface ", classeNomSimpleGenApiService, " {");
//			auteurGenApiService.tl(1, "// Une méthode d'usine pour créer une instance et un proxy. ");
      ...
      for(String langueNom : toutesLangues) {
        ...
        for(String classeApiMethode : classeApiMethodes) {
          ...
          String classePageNomCanoniqueMethode = classeDoc.getString("classePageNomCanonique" + classeApiMethode + "_" + langueNom + "_stored_string");
          String classeApiTypeMediaRequeteMethode = classeDoc.getString("classeApiTypeMediaRequete" + classeApiMethode + "_" + langueNom + "_stored_string");
        ...
        if(rechercheListe.size() > 0) {
          for(Long i = rechercheListe.getStart(); i < rechercheListe.getNumFound(); i+=rechercheLignes) {
            for(Integer j = 0; j < rechercheListe.size(); j++) {
              ...
              entiteAttribuerVarId = (String)doc.get("entiteAttribuerVarId_" + classeLangueNom + "_stored_string");
              entiteAttribuerAttribuer = BooleanUtils.isTrue((Boolean)doc.get("entiteAttribuerAttribuer_stored_boolean"));
              entiteAttribuerAttribuer = BooleanUtils.isTrue((Boolean)doc.get("entiteAttribuerAttribuer_stored_boolean"));
              entiteAttribuerAttribuerNomSimple = (String)doc.get("entiteAttribuerAttribuerNomSimple_" + classeLangueNom + "_stored_string");
              entiteAttribuerAttribuerVar = (String)doc.get("entiteAttribuerAttribuerVar_" + classeLangueNom + "_stored_string");
              entiteAttribuerAttribuerVarId = (String)doc.get("entiteAttribuerAttribuerVarId_" + classeLangueNom + "_stored_string");
              ...
              entiteFormatChaine = (String)doc.get("entiteFormatChaine_stored_string");
              ...
              // classeMessage, entiteVarsMesage
              if(entiteDefinir && !BooleanUtils.isTrue(entiteAttribuer)) {
                ...
                if(entiteFormatChaine != null)
                  wUpsert.tl(7 + jEtape, entiteNomSimpleVertxJson, " ", entiteVar, " = ", entiteFormatChaine, ";");
                else
                ...
                if(classeMessage != null && entiteVarsMessage != null && entiteVarsMessage.size() > 0) {
                  ...
                  wUpsert.tl(7 + jEtape, entiteFormatChaine == null ? "//" : "", " json.put(", classeNomSimple, ".varJson(", classeNomSimple, ".VAR_", entiteVar, ", patch), ", entiteVar, ");");
                }
              }
                ...
                if(!entiteAttribuerAttribuer || StringUtils.compare(entiteVar, entiteAttribuerVar) <= 0) {
                  if("array".equals(entiteTypeJson) && "array".equals(entiteAttribuerTypeJson)) {
                    ...
                    if(entiteAttribuerAttribuer && classeNomSimple.equals(entiteAttribuerAttribuerNomSimple) && entiteVar.equals(entiteAttribuerAttribuerVar)) {
                      tl(8, "search", entiteAttribuerEtendModeleBase ? "Model" : "Result", "(siteRequest).query(", entiteAttribuerNomSimple, ".var", i18nGlobale.getString(I18n.var_Indexe), entiteAttribuerNomSimple, "(", entiteAttribuerNomSimple, ".VAR_", entiteAttribuerAttribuerVarId, "), ", entiteAttribuerNomSimple, ".class, val).onSuccess(o3 -> {");
                    } else {
                      tl(8, "search", entiteAttribuerEtendModeleBase ? "Model" : "Result", "(siteRequest).query(", entiteAttribuerNomSimple, ".var", i18nGlobale.getString(I18n.var_Indexe), entiteAttribuerNomSimple, "(", entiteAttribuerNomSimple, ".VAR_", entiteAttribuerVar, "), ", entiteAttribuerNomSimple, ".class, val).onSuccess(o3 -> {");
                    }
                    tl(9, "String ", i18nGlobale.getString(I18n.var_solrId), "2 = Optional.ofNullable(o3).map(o4 -> o4.get", solrIdCapitalise, "()).filter(", i18nGlobale.getString(I18n.var_solrId), "3 -> !", i18nGlobale.getString(I18n.var_solrIds), ".contains(", i18nGlobale.getString(I18n.var_solrId), "3)).orElse(null);");
                    ...
                    tl(9, "sql(", i18nGlobale.getString(I18n.var_requeteSite), ").update(", classeNomSimple, ".class, ", classeVarClePrimaire, ").set(", classeNomSimple, ".VAR_", entiteVar, ", ", entiteAttribuerNomSimple, ".class, ", i18nGlobale.getString(I18n.var_solrId), "2, val).onSuccess(a -> {");
                    if(entiteAttribuerAttribuer && classeNomSimple.equals(entiteAttribuerAttribuerNomSimple) && entiteVar.equals(entiteAttribuerAttribuerVar)) {
                      tl(10, "sql(", i18nGlobale.getString(I18n.var_requeteSite), ").update(", entiteAttribuerNomSimple, ".class, ", classeVarClePrimaire, "2).set(", entiteAttribuerNomSimple, ".VAR_", entiteAttribuerVar, ", ", classeNomSimple, ".class, o.get", solrIdCapitalise, "(), ((", entiteAttribuerNomSimple, ")o3).get", StringUtils.capitalize(entiteAttribuerAttribuerVarId), "()).onSuccess(b -> {");
...
//										tl(6, "break;");
  ...
  public void ecrireGenApiServiceImpl2(String classeLangueNom) throws Exception {
    ...
    if(auteurGenApiServiceImpl != null) {
      o = auteurGenApiServiceImpl;
      classeAuthPortees = Optional.ofNullable(classeDoc.getJsonArray("classeAuthPortees_stored_strings")).orElse(new JsonArray()).stream().map(v -> (String)v).collect(Collectors.toList());
      l();
      l("/**");
      ...
      for(String langueNom : toutesLangues) {
        ...
        if(classeApiMethodes == null)
          classeApiMethodes = new ArrayList<>();
        for(String classeApiMethode : classeApiMethodes) {
          classePageNomCanoniqueMethode = classeDoc.getString("classePageNomCanonique" + classeApiMethode + "_" + langueNom + "_stored_string");
          classePageNomSimpleMethode = classeDoc.getString("classePageNomSimple" + classeApiMethode + "_" + langueNom + "_stored_string");
          classeApiOperationIdMethode = classeDoc.getString("classeApiOperationId" + classeApiMethode + "_" + langueNom + "_stored_string");
          classeApiUriMethode = classeDoc.getString("classeApiUri" + classeApiMethode + "_" + langueNom + "_stored_string");
          classeApiMethodeMethode = classeDoc.getString("classeApiMethode" + classeApiMethode + "_" + langueNom + "_stored_string");
          classeApiTypeMedia200Methode = classeDoc.getString("classeApiTypeMedia200" + classeApiMethode + "_" + langueNom + "_stored_string");
          classeApiTypeMediaRequeteMethode = classeDoc.getString("classeApiTypeMediaRequete" + classeApiMethode + "_" + langueNom + "_stored_string");
          // classePageLangueNom = classeDoc.getString("classePageLangueNom" + classeApiMethode + "_" + langueNom + "_stored_string");
          classePageTemplateMethode = classeDoc.getString("classe" + classeApiMethode + "Template_" + langueNom + "_stored_string");
          classePageAvecTemplateMethode = classeDoc.getBoolean("classePageAvecTemplate" + classeApiMethode + "_stored_boolean");
          classeApiPortee = classeDoc.getString("classeApiPortee" + classeApiMethode + "_stored_string");
          ...
          // if(classePageLangueNom == null || classePageLangueNom.equals(classeLangueNom)) {
            ...
            if(classeApiMethode.contains(i18nGlobale.getString(I18n.var_PageEdition))
              ...
              if(
                ...
                if(authPolitiqueGranulee) {
                  ...
                  for(String classeAuthPortee : classeAuthPortees) {
              ...
              tl(7, i18nGlobale.getString(I18n.var_rechercher), classeApiClasseNomSimple, i18nGlobale.getString(I18n.var_Liste), "(", i18nGlobale.getString(I18n.var_requeteSite), ", false, true, false, \"", classeApiPortee, "\").onSuccess(", i18nGlobale.getString(I18n.var_liste), classeNomSimple, " -> {");
              ...
              tl(3, "try {");
              tl(4, i18nGlobale.getString(I18n.var_requeteSite), ".setLang(\"", langueNom, "\");");
              if(classeApiMethode.contains("PATCH") && classePartsUtilisateurSite != null && classePartsUtilisateurSite.nomSimple(classeLangueNom).equals(classeNomSimple)) {
                // PATCH SiteUser updates Keycloak user profile attributes. 
                tl(4, "MultiMap form = MultiMap.caseInsensitiveMultiMap();");
                tl(4, "form.add(\"username\", config.getString(ComputateConfigKeys.AUTH_ADMIN_USERNAME));");
                tl(4, "form.add(\"password\", config.getString(ComputateConfigKeys.AUTH_ADMIN_PASSWORD));");
                tl(4, "form.add(\"grant_type\", \"password\");");
                tl(4, "form.add(\"client_id\", \"admin-cli\");");
                tl(4, "webClient.post(");
                tl(6, "config.getInteger(ComputateConfigKeys.AUTH_PORT)");
                tl(6, ", config.getString(ComputateConfigKeys.AUTH_HOST_NAME)");
                tl(6, ", \"/realms/master/protocol/openid-connect/token\"");
                tl(6, ")");
                tl(6, ".ssl(config.getBoolean(ComputateConfigKeys.AUTH_SSL))");
                tl(6, ".sendForm(form)");
                tl(4, ".onSuccess(adminTokenResponse -> {");
                tl(5, "try {");
                tl(6, "String adminAuthToken = adminTokenResponse.bodyAsJsonObject().getString(\"access_token\");");
                tl(6, "String authRealm = config.getString(ComputateConfigKeys.AUTH_REALM);");
                tl(6, "String userId = ", i18nGlobale.getString(I18n.var_requeteSite), ".getUserId();");
                tl(6, "webClient.get(");
                tl(8, "config.getInteger(ComputateConfigKeys.AUTH_PORT)");
                tl(8, ", config.getString(ComputateConfigKeys.AUTH_HOST_NAME)");
                tl(8, ", String.format(\"/admin/realms/%s/users/%s\", authRealm, userId)");
                tl(8, ")");
                tl(8, ".ssl(config.getBoolean(ComputateConfigKeys.AUTH_SSL))");
                tl(8, ".putHeader(\"Authorization\", String.format(\"Bearer %s\", adminAuthToken))");
                tl(8, ".send()");
                tl(8, ".expecting(HttpResponseExpectation.SC_OK)");
                ...
                tl(8, "});");
                tl(8, "webClient.put(");
                tl(10, "config.getInteger(ComputateConfigKeys.AUTH_PORT)");
                tl(10, ", config.getString(ComputateConfigKeys.AUTH_HOST_NAME)");
                tl(10, ", String.format(\"/admin/realms/%s/users/%s\", authRealm, userId)");
                tl(10, ")");
                tl(10, ".ssl(config.getBoolean(ComputateConfigKeys.AUTH_SSL))");
                tl(10, ".putHeader(\"Authorization\", String.format(\"Bearer %s\", adminAuthToken))");
                tl(10, ".putHeader(\"Content-Type\", \"application/json\")");
                tl(10, ".sendJsonObject(userBody)");
                tl(10, ".expecting(HttpResponseExpectation.SC_NO_CONTENT)");
                tl(8, ".onSuccess(userUpdateResponse -> {");
                tl(9, "try {");
                tl(10, i18nGlobale.getString(I18n.var_reponse), "200", classeApiMethode, classeNomSimple, "(", i18nGlobale.getString(I18n.var_requeteSite), ").onSuccess(", i18nGlobale.getString(I18n.var_reponse), " -> {");
                tl(11, "LOG.debug(String.format(\"", classeApiOperationIdMethode, " ", i18nGlobale.getString(I18n.str_a_réussi), ". \"));");
                tl(11, i18nGlobale.getString(I18n.var_gestionnaireEvenements), ".handle(Future.succeededFuture(", i18nGlobale.getString(I18n.var_reponse), "));");
                tl(10, "}).onFailure(ex -> {");
                tl(11, "LOG.error(String.format(\"", classeApiOperationIdMethode, " ", i18nGlobale.getString(I18n.str_a_échoué), ". \"), ex);");
                tl(11, i18nGlobale.getString(I18n.var_erreur), "(", i18nGlobale.getString(I18n.var_requeteSite), ", ", i18nGlobale.getString(I18n.var_gestionnaireEvenements), ", ex);");
                tl(10, "});");
                tl(9, "} catch(Throwable ex) {");
                tl(10, "LOG.error(String.format(\"", classeApiOperationIdMethode, " ", i18nGlobale.getString(I18n.str_a_échoué), ". \"), ex);");
                tl(10, i18nGlobale.getString(I18n.var_erreur), "(null, ", i18nGlobale.getString(I18n.var_gestionnaireEvenements), ", ex);");
                tl(9, "}");
                tl(8, "}).onFailure(ex -> {");
                tl(9, "LOG.error(String.format(\"", classeApiOperationIdMethode, " ", i18nGlobale.getString(I18n.str_a_échoué), ". \"), ex);");
                tl(9, i18nGlobale.getString(I18n.var_erreur), "(null, ", i18nGlobale.getString(I18n.var_gestionnaireEvenements), ", ex);");
                tl(8, "});");
                tl(7, "} catch(Throwable ex) {");
                tl(8, "LOG.error(String.format(\"", classeApiOperationIdMethode, " ", i18nGlobale.getString(I18n.str_a_échoué), ". \"), ex);");
                tl(8, i18nGlobale.getString(I18n.var_erreur), "(null, ", i18nGlobale.getString(I18n.var_gestionnaireEvenements), ", ex);");
                tl(7, "}");
                tl(6, "}).onFailure(ex -> {");
                tl(7, "LOG.error(String.format(\"", classeApiOperationIdMethode, " ", i18nGlobale.getString(I18n.str_a_échoué), ". \"), ex);");
                tl(7, i18nGlobale.getString(I18n.var_erreur), "(null, ", i18nGlobale.getString(I18n.var_gestionnaireEvenements), ", ex);");
                tl(6, "});");
                tl(5, "} catch(Throwable ex) {");
                tl(6, "LOG.error(String.format(\"", classeApiOperationIdMethode, " ", i18nGlobale.getString(I18n.str_a_échoué), ". \"), ex);");
                tl(6, i18nGlobale.getString(I18n.var_erreur), "(null, ", i18nGlobale.getString(I18n.var_gestionnaireEvenements), ", ex);");
                tl(5, "}");
                tl(4, "}).onFailure(ex -> {");
                ...
                if(classeApiMethode.contains("POST")) {
                  ...
                  tl(7, i18nGlobale.getString(I18n.var_rechercher), classeApiClasseNomSimple, i18nGlobale.getString(I18n.var_Liste), "(", i18nGlobale.getString(I18n.var_requeteSite), ", ", (classeModele ? "false, true" : "true, false"), ", true, \"", classeApiPortee, "\").onSuccess(", i18nGlobale.getString(I18n.var_liste), classeNomSimple, " -> {");
                  tl(8, "try {");
                  Integer tBase;
                  tBase = 0;
                  ...
                  tl(7, i18nGlobale.getString(I18n.var_rechercher), classeApiClasseNomSimple, i18nGlobale.getString(I18n.var_Liste), "(", i18nGlobale.getString(I18n.var_requeteSite), ", false, true, true, \"", classeApiPortee, "\").onSuccess(", i18nGlobale.getString(I18n.var_liste), classeNomSimple, " -> {");
            ...
            if(StringUtils.contains(classeApiMethode, "POST")) {
              ...
              tl(5, "});");
              tl(4, "});");
              tl(4, i18nGlobale.getString(I18n.var_rechercher), classeApiClasseNomSimple, i18nGlobale.getString(I18n.var_Liste), "(", i18nGlobale.getString(I18n.var_requeteSite), ", false, true, true, \"", classeApiPortee, "\").onSuccess(", i18nGlobale.getString(I18n.var_liste), classeNomSimple, " -> {");
              tl(5, "try {");
  ...
  public void ecrireGenApiServiceImpl4(String classeLangueNom) throws Exception {
    ...
    if(auteurGenApiServiceImpl != null) {
      ...
      List<String> classeApiMethodes = Optional.ofNullable(classeDoc.getJsonArray("classeApiMethodes_" + classeLangueNom + "_stored_strings")).orElse(new JsonArray()).stream().map(v -> (String)v).collect(Collectors.toList());
      if(classeApiMethodes == null)
        classeApiMethodes = new ArrayList<>();
...
//			tl(3, classeLangueConfig.getString(ConfigCles.var_listeRecherche), ".setParam(\"hl.encoder\", \"html\");");
      ...
      if(classePartsUtilisateurSite != null && classePartsUtilisateurSite.nomSimple(classeLangueNom).equals(classeNomSimple)) {
        ...
        tl(4, classePartsListeRecherche.nomSimple(classeLangueNom), "<", classeApiClasseNomSimple, "> ", i18nGlobale.getString(I18n.var_listeRecherche), " = new ", classePartsListeRecherche.nomSimple(classeLangueNom), "<", classeApiClasseNomSimple, ">();");
        tl(4, i18nGlobale.getString(I18n.var_listeRecherche), ".setScope(", i18nGlobale.getString(I18n.var_portee), ");");
        ...
        tl(3, i18nGlobale.getString(I18n.var_listeRecherche), ".setScope(", i18nGlobale.getString(I18n.var_portee), ");");
...
//			t l(8, langueConfig.getString(ConfigCles.var_liste), langueConfig.getString(ConfigCles.var_Recherche), ".addField(var", langueConfig.getString(ConfigCles.var_Indexe), ");");
      ...
      if(classePageAvecTemplate) {
        l();
        tl(1, "@Override");
        tl(1, "public Future<JsonObject> ", i18nGlobale.getString(I18n.var_genererCorpsPage), "(ComputateSiteRequest ", i18nGlobale.getString(I18n.var_requeteSite), ", Map<String, Object> ctx, String ", i18nGlobale.getString(I18n.var_templateChemin), ", String ", i18nGlobale.getString(I18n.var_classeNomSimple), ", String ", i18nGlobale.getString(I18n.var_templatePage), ") {");
        tl(2, "Promise<JsonObject> promise = Promise.promise();");
        tl(2, "try {");
