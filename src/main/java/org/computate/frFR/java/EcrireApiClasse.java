...
//						tl(5, str_requeteApi(classeLangueNom), ".setNumPATCH(", str_requeteApi(classeLangueNom), ".getNumPATCH() + 1);");
					...
					if(StringUtils.containsAny(classeApiMethode, "POST", str_PUTCopie(classeLangueNom), "PATCH")) {
						...
						if(classeApiMethode.contains("POST")) {
							...
							tl(4, str_creer(classeLangueNom), classeNomSimple, "(", str_requeteSite(classeLangueNom), ", c -> {");
							tl(5, "if(c.succeeded()) {");
							tl(6, classeNomSimple, " ", uncapitalizeClasseNomSimple, " = c.result();");
							tl(6, "sql", classeApiMethode, classeNomSimple, "(", uncapitalizeClasseNomSimple, ", jsonObject, d -> {");
							tl(7, "if(d.succeeded()) {");
							tl(8, classeNomSimple, " ", uncapitalizeClasseNomSimple, " = d.result();");
							tl(8, str_definir(classeLangueNom), classeNomSimple, "(", uncapitalizeClasseNomSimple, ", c -> {");
							tl(9, "if(c.succeeded()) {");
							tl(10, str_attribuer(classeLangueNom), classeNomSimple, "(", uncapitalizeClasseNomSimple, ", d -> {");
							tl(11, "if(d.succeeded()) {");
							...
							tl(8, "});");
							tl(7, "} else {");
							tl(8, "LOG.error(String.format(\"", classeApiOperationIdMethode, "Future ", str_a_échoué(classeLangueNom), ". \", d.cause()));");
							tl(8, str_gestionnaireEvenements(classeLangueNom), ".handle(Future.failedFuture(d.cause()));");
							tl(7, "}");
							tl(6, "});");
							tl(5, "} else {");
							tl(6, "LOG.error(String.format(\"", classeApiOperationIdMethode, "Future ", str_a_échoué(classeLangueNom), ". \", c.cause()));");
							tl(6, str_gestionnaireEvenements(classeLangueNom), ".handle(Future.failedFuture(c.cause()));");
							tl(5, "}");
							tl(4, "});");
							tl(4, "return promise1.future();");
							tl(3, "}).onSuccess(a -> {");
