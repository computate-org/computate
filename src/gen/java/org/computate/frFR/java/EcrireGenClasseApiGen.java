...
public abstract class EcrireGenClasseApiGen extends HttpServlet {
	...
	public void ecrireJsonEcrireGenClasse(String entiteVarStocke, Collection<Object> champValeurs) throws Exception {
		...
		if(resultatsRecherche != null) {
			for(Integer i = 0; i < resultatsRecherche.size(); i++) {
				...
				for(String champNomStocke : champNoms) {
					...
					ecrireJsonEcrireGenClasse(champNomStocke, champValeurs);
					j++;
				}
				ecrivain.write("\t\t}\n");
			}
