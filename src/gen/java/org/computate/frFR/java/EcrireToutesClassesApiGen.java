 ...
 */
public abstract class EcrireToutesClassesApiGen implements Handler<RoutingContext> {
	...
	public void handleGetEcrireToutesClassesApiGen(Vertx vertx, Router router, OAuth2Auth oauth2) {
	...
	public void genererGetIndividuel(ResultatRecherche resultatRecherche) throws Exception {
		...
		for(String champNomStocke : champNoms) {
			...
			j = genererGetEcrireToutesClasses(j, reponseServeur, champNomStocke, champValeurs);
		}
		reponseServeur.write("\t\t}\n");
	}
	...
	public String varIndexeEcrireToutesClasses(String entiteVar) throws Exception {
		switch(entiteVar) {
			default:
			...
			for(String paramValeur : paramValeurs) {
				switch(paramCle) {
					case "q":
						...
						varIndexe = varIndexeEcrireToutesClasses(paramCle);
	...
	public Integer genererGetEcrireToutesClasses(Integer j, String entiteVarStocke, Collection<Object> champValeurs) throws Exception {
	...
	public Integer genererPostEcrireToutesClasses(Integer j, String entiteVarStocke, Collection<Object> champValeurs) throws Exception {
		if(!champValeurs.isEmpty()) {
			Object champValeur = champValeurs.iterator().next();
			if(champValeur != null) {
			}
